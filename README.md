...
Make edits using [Markdown syntax](https://help.sumologic.com/contributing/style-guide/#markdown). Keep contributions concise, informative, and aligned with our guidelines.
