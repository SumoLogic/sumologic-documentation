...
* The timeshift [metrics operator](/docs/metrics/metric-queries-alerts/operators) (../../metrics/Metric-Queries-Alerts/operators.md "Metrics Operators") is not supported in a Metric Monitor.
