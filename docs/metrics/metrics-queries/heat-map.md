...
<img src={useBaseUrl('img/metrics/heat-map.png')} alt="Heat map" style={{border: '1px solid gray'}} width="800" />

To create a heat map:

1. Enter and run a metrics query.
1. On the **Chart** tab, select **Heatmap** from the **Chart Type** dropdown. <br/> <img src={useBaseUrl('img/metrics/heat-map-option.png')} alt="Heat map option" style={{border: '1px solid gray'}} width="800" />
1. A heatmap appears, visualizing one of the metrics returned by the query. If the query returns multiple metrics, you can use the **Metric** dropdown to select a different metric to visualize.<br/> <img src={useBaseUrl('img/metrics/heat-map-metric.png')} alt="Heat map metric" style={{border: '1px solid gray'}} width="800" />
