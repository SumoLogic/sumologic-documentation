...
|:---|:---|
| `//` | You can comment out part of a line or a complete line by prefacing it with two forward slashes. You can insert the comment characters with `cmd /` on macOS or `ctrl /` on Windows. |
