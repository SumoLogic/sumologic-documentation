...
<img src={useBaseUrl('img/icons/metrics.png')} alt="icon" width="50"/>
...
<div className="box smallbox1 card">
  ...
  <h4><a href="/docs/metrics/introduction">Intro to Metrics</a></h4>
  <p>Use Metrics for monitoring, troubleshooting, and identifying root causes.</p>
  </div>
</div>
<div className="box smallbox2 card">
  <div className="container">
  <h4><a href="/docs/metrics/metrics-queries">Metrics Queries</a></h4>
  <p>Sumo Logic metric query operators and metrics queries.</p>
  </div>
</div>
<div className="box smallbox3 card">
  <div className="container">
  <h4><a href="/docs/metrics/metrics-operators">Metrics Operators</a></h4>
  <p>Metrics operator syntax rules and examples.</p>
  </div>
</div>
<div className="box smallbox4 card">
  <div className="container">
  <h4><a href="/docs/metrics/manage-metric-volume/manage-metric-volume">Managing Metrics Volume</a></h4>
  <p>Metric ingestion and storage, metric data limits, and metrics throttling.</p>
  </div>
</div>
<div className="box smallbox5 card">
  <div className="container">
  <h4><a href="/docs/metrics/metric-rules-editor">Metrics Rules Editor</a></h4>
  <p>The Metrics rules editor allows you to tag metrics with data derived from the metric identifier.</p>
  </div>
</div>
<div className="box smallbox6 card">
  <div className="container">
  <h4><a href="/docs/metrics/metrics-transformation-rules">Metrics Transformation Rules</a></h4>
  <p>Control how long raw metrics are retained.</p>
  </div>
</div>
<div className="box smallbox7 card">
  <div className="container">
  <h4><a href="/docs/metrics/logs-to-metrics">Logs to Metrics</a></h4>
  <p>Set up rules to extract or create metrics from log data.</p>
  </div>
</div>
<div className="box smallbox8 card">
  <div className="container">
  <h4><a href="/docs/metrics/kubernetes-metrics">Kubernetes Metrics</a></h4>
  <p>Kubernetes metrics are collected when you deploy our Kubernetes collection.</p>
  </div>
</div>
<div className="box smallbox9 card">
  <div className="container">
  <h4><a href="/docs/metrics/metric-charts">Metrics Charts</a></h4>
