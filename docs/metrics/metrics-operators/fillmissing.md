...
:::note
The `fillmissing` operator is supported in the metric query tab, and in the [Metrics Query Builder](/docs/metrics/metric-queries-alerts/metrics-explorer), currently in beta. 
:::
