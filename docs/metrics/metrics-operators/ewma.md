...
:::note
Currently, the `ewma` operator is supported only in the Metrics Explorer’s [advanced mode](/docs/metrics/metric-queries-alerts/metrics-explorer), not basic mode.
:::
