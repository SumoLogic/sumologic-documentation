...
<div className="box smallbox card">
  <div className="container">
    ...
    <a href="https://www.sumologic.com/release-notes-service/rss.xml">
...
<div className="box smallbox card">
  <div className="container">
    ...
    <a href="https://www.sumologic.com/release-notes-collector/rss.xml">
      <img src={useBaseUrl('img/release-notes/rss.png')} alt="RSS Feed" width="45" />
    </a>
...
<div className="box smallbox card">
  <div className="container">
    ...
    <a href="https://www.sumologic.com/release-notes-cse/rss.xml">
      <img src={useBaseUrl('img/release-notes/rss.png')} alt="RSS Feed" width="45" />
    </a>
...
<div className="box smallbox card">
  <div className="container">
    ...
    <a href="https://www.sumologic.com/release-notes-csoar/rss.xml">
      <img src={useBaseUrl('img/release-notes/rss.png')} alt="RSS Feed" width="45" />
    </a>
...
<div className="box smallbox card">
  <div className="container">
    ...
    <a href="https://www.sumologic.com/release-notes-developer/rss.xml">
      <img src={useBaseUrl('img/release-notes/rss.png')} alt="RSS Feed" width="45" />
    </a>
