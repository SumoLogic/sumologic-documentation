...
<div className="box smallbox card">
  ...
  <a href="/release-notes-service"><img src={useBaseUrl('img/icons/dashboards.png')} alt="icon" width="40"/><h4>Services <img src={useBaseUrl('img/release-notes/rss-orange2.png')} alt="icon" width="40"/></h4></a>
...
<div className="box smallbox card">
  <div className="container">
  <a href="/release-notes-collector"><img src={useBaseUrl('img/icons/operations/data-collection.png')} alt="icon" width="40"/><h4>Collector <img src={useBaseUrl('img/release-notes/rss-orange2.png')} alt="icon" width="40"/></h4></a>
