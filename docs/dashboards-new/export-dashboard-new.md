...
You can generate and download your Dashboard (New) dashboards in PDF, PNG, and [JSON] (../../01Start-Here/Library/Export-and-Import-Content-in-the-Library.md) format.
