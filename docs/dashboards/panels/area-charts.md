...
which would produce results such as:<br/><img src={useBaseUrl('/img/dashboards/panels/area-charts/Result.png')} style={{border: '1px solid gray'}} alt="Result" width="400"/>

## Create an area chart

To add a panel with an area chart:
1. Create or open a Dashboard and click on **Add Panel > Time Series** or **Add Panel > Categorical**.<br/><img src={useBaseUrl('/img/dashboards/panels/area-charts/time-series-or-categorical.png')} style={{border: '1px solid gray'}} alt="time series or categorical" width="600"/>
1. Provide a Metric or Log query and press **Enter** for it to run.
1. Once the query runs you will need to flip the chart type to **Area**.<br/><img src={useBaseUrl('/img/dashboards/panels/area-charts/Dashboard-New-Area-Chart.png')} style={{border: '1px solid gray'}} alt="Dashboard Area Chart" width="700"/>
