...
1. Click the **Add Dashboard Link** from the bottom of the general settings menu.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/mar-21-add-dashboard-link.png')} style={{border: '1px solid gray'}} alt="mar 21 add dashboard link" width="400"/>
1. Click in the **Dashboard Name** input area and select or enter the name of the dashboard you want the panel to link to.
    ...
    * Select to **Include Time Range** if you want the linked dashboard to run with the time range of this panel.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/Add-dashboard-link.png')} style={{border: '1px solid gray'}} alt="Add dashboard link" width="400"/>
...
1. Click the **Display** icon in the menu bar.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/display-settings-dashboard-new.png')} style={{border: '1px solid gray'}} alt="display settings dashboard new" width="400"/>
1. You can change the **Panel Type** by selecting another type icon.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/panel-type-change.png')} style={{border: '1px solid gray'}} alt="panel type change" width="400"/>
1. To change the format of the chart click **Chart Type** and make a selection from the dropdown list.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/MC_Display_ChartType.png')} style={{border: '1px solid gray'}} alt="MC_Display_ChartType" width="400"/>
1. To change the colors of the chart display click **Color Palette** and make a selection from the dropdown list.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/MC_Display_Format_ColorPalette.png')} style={{border: '1px solid gray'}} alt="MC_Display_Format_ColorPalette" width="400"/>
1. Make selections for the other format options available for the chart type.<br/><img src={useBaseUrl('/img/dashboards-new/panels/modify-chart/MC_Display_modify-results.png')} style={{border: '1px solid gray'}} alt="MC_Display_modify" width="700"/>
