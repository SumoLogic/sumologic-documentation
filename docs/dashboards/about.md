...
* No dashboard query can return more than 1440 data points. If the dashboard panel has more than 1440 pixels in width, additional resolution in data will be down-sampled to get rendered on the screen.
