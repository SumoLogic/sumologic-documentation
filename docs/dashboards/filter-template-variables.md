...
1. In the Dashboard top menu bar, click the filter icon to show the variables option. The filter icon allows you to toggle if the variables option is displayed or hidden.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/Show-and-Hide-filters.png')} style={{border:'1px solid black'}} alt="Show-and-Hide-filters" width="250"/>
1. In the Dashboard top menu bar, click the **plus (+) icon**. The **Create Template Variable** panel appears.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/create-dashboard-filter.png')} style={{border:'1px solid black'}} alt="create-dashboard-filter" width="800"/>
...
1. In the Dashboard top menu bar, click the filter icon to show the variables option. The filter icon allows you to toggle if the variables option is displayed or hidden.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/Show-and-Hide-filters.png')} style={{border:'1px solid black'}} alt="Show-and-Hide-filters" width="250"/>
1. In the Dashboard top menu bar, click the **plus (+) icon**. The **Create Template Variable** panel appears.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/create-dashboard-filter.png')} style={{border:'1px solid black'}} alt="create-dashboard-filter" width="800"/>
1. In the **Create Template Variable** panel, enter a unique **Variable Name**. Spaces and special characters, with the exception of an underscore (_), are not allowed in value names.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/dashboard-new-metrics-metadata-search-variable.png')} style={{border:'1px solid black'}} alt="dashboard-new-metrics-metadata-search-variable" width="800"/>
...
1. In the Dashboard top menu bar, click the filter icon to show the variables option. The filter icon allows you to toggle if the variables option is displayed or hidden.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/Show-and-Hide-filters.png')} style={{border:'1px solid black'}} alt="Show-and-Hide-filters" width="250"/>
1. In the Dashboard top menu bar, click the **plus (+) icon**. The **Create Template Variable** panel appears.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/create-dashboard-filter.png')} style={{border:'1px solid black'}} alt="create-dashboard-filter" width="800"/>
1. In the **Create Template Variable** panel, enter a unique **Variable Name**. Spaces and special characters, with the exception of an underscore (_), are not allowed in value names.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/Variable-for-logs-search.png')} style={{border:'1px solid black'}} alt="Variable-for-logs-search" width="800"/>
...
1. Hover the cursor over the end of the template variable field to display the options icon.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/options-menu-for-variable.png')} style={{border:'1px solid black'}} alt="options-menu-for-variable" width="800"/>
1. Click the **Details** icon and select **Edit** from the dropdown menu. The Edit Variable dialog appears.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/edit-variable.png')} style={{border:'1px solid black'}} alt="edit-variable" width="800"/>
1. Edit the variable as needed.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/edit-variable-dialog.png')} style={{border:'1px solid black'}} alt="edit-variable-dialog" width="800"/>
...
1. Select the desired variable from the dropdown list. It appears in curly braces to indicate it is a variable.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/Metrics_variable_query_example1.png')} style={{border:'1px solid black'}} alt="Metrics_variable_query_example1" width="400"/>
<br/>The variable is inserted into the query and will convert the variable into the appropriate value, as shown in the following example.<br/><img src={useBaseUrl('img/dashboards-new/filter-template-variables/Metrics_variable_query_example2.png')} style={{border:'1px solid black'}} alt="Metrics_variable_query_example2" width="400"/>
