...
1. <!--Kanso [**Classic UI**](/docs/get-started/sumo-logic-ui/). Kanso--> Click the **+ New** button at the top of the screen and select **Live Tail**. <!--Kanso <br/>[**New UI**](/docs/get-started/sumo-logic-ui). In the main Sumo Logic menu, select **Logs > Live Tail**. You can also click the **Go To...** menu at the top of the screen and select **Live Tail**. Kanso--> 
