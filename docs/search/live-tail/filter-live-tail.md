...
:::note
Ensure that you use appropriate keywords for effective Live Tail usage and avoid exceeding the limitations described in the [About Live Trail](/docs/search/live-tail/about-live-tail/#limitations).
:::
