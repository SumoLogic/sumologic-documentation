...
* A table of saved data generated by the [Save](https://help.sumologic.com/docs/search/search-query-language/search-operators/save/) operator.
...
* If looking up a [metadata](/docs/search/get-started-with-search/search-basics/built-in-metadata) field you need to either [rename the field](/docs/search/search-query-language/search-operators/as/) using the `as` option in the lookup operation or [filter null values](/docs/search/search-query-language/search-operators/isnull-isempty-isblank/) immediately after the lookup operation.
