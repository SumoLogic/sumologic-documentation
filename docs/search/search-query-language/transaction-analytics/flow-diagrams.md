...
<img src={useBaseUrl('img/reuse/query-search/Flow_Diagram_example.png')} alt="Flow diagram" width="800" />
...
1. In the Aggregates tab of the **Search** page, click the **Flow Diagram** icon.<br/><img src={useBaseUrl('img/reuse/query-search/FlowDiagram.png')} alt="Flow diagram" style={{border: '1px solid gray'}} width="800" />
...
1. After running a transaction operator query, hover over a line in the Flow Diagram.<br/><img src={useBaseUrl('img/reuse/query-search/Flow_Diagram_drilldown.png')} alt="Diagram" style={{border: '1px solid gray'}} width="800" />
1. Click the line.
