...
The **queryEndTime()** operator returns the end time of the search [time range](../../get-started-with-search/build-search/set-time-range.md) in milliseconds. You can use it in combination with [queryStartTime()](queryStartTime.md) to establish times and ranges for your non-continuous queries.
