...
When you run a search your results are provided in a **Messages** tab. If the search conducted an aggregation you will also get an **Aggregates** tab.
...
* Hold click and drag the vertical line in between the columns to adjust the width.  
    ...
    ![resize column.png](/img/search/get-started-search/how-to-use-search-page/navigate-through-search-results/resize-column.png)
...
* **Pin**: Hold click and drag a column from the header row to the far left of the table. You will see a small pin icon when in the correct area to unclick.  

    ![pin aggregated column.gif](/img/search/get-started-search/how-to-use-search-page/navigate-through-search-results/pin-aggregated-column.gif)
...
![expand message option.png](/img/search/get-started-search/how-to-use-search-page/navigate-through-search-results/expand-message-option.png)
...
![copy message option.png](/img/search/get-started-search/how-to-use-search-page/navigate-through-search-results/copy-message-option.png)
...
![JIRA_94232-3.png](/img/search/get-started-search/how-to-use-search-page/navigate-through-search-results/JIRA_94232-3.png)
