...
When performing queries in the **Log Search** UI, you can visualize and filter log-level distribution in both your Histogram results and Messages table view, helping you to:
