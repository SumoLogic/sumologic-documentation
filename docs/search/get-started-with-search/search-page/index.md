...
<div className="box smallbox3 card">
  ...
  <p>The Field Browser allows you to zero in on just the fields of interest in a search by displaying or hiding selected fields without having to parse them. It is further divided into two concepts: Search from the Field Browser and Show and Hide Fields in the Field Browser.</p>
  </div>
</div>
