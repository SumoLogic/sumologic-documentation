...
* **Data Tier**. Select from the dropdown which Data Tier the query should run against, either Continuous, Frequent, Infrequent, or Flex. See [Searching Data Tiers](/docs/manage/partitions-data-tiers/searching-data-tiers) for further details.
