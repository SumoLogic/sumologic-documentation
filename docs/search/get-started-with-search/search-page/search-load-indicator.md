...
description: The search load indicator shows current system load and suggests ways to reduce it, such as making your query more specific.
---
...
## Get suggestions to reduce load
