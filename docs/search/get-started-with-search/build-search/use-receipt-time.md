...
1. Click the gear icon to open the **Search Config** menu and select the **Use Receipt Time** timestamp.<br/><img src={useBaseUrl('img/search/get-started-search/build-search/receipt-time-option.png')} alt="receipt time option.png" style={{border: '1px solid gray'}} width="450"/>
