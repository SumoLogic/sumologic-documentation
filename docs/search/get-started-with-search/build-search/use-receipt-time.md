...
parsing format for the Source, and test the format to make sure it is valid. See [troubleshooting large message time and receipt time discrepancies](https://help.sumologic.com/docs/send-data/collector-faq/#troubleshooting-time-discrepancies).
