...
<div className="box smallbox card">
  ...
  <a href={useBaseUrl('docs/search/get-started-with-search/build-search/about-build-search')}><img src={useBaseUrl('img/icons/operations/frequent-search.png')} alt="Frequent Search icon" width="40"/><h4>Discover What Data You Have</h4></a>
  <p>Identify what source categories, source hosts, and source names exist in your Sumo Logic environment.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
...
<div className="box smallbox card">
  ...
  <p>Quickly start a search for a Collector, Source, or Source Category from the Data Collection page.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
