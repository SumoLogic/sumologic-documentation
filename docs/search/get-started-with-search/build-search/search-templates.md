...
1. Optional. Select the available values.
    ...
    1. For a lookup file, you must enter a valid [lookup (classic)](docs/search/search-query-language/search-operators#lookup-classic) file that you have [saved](docs/search/search-query-language/search-operators#save-lookups-classic). 
...
1. Enter in a valid [lookup (classic)](docs/search/search-query-language/search-operators#lookup-classic) file that you have [saved](docs/search/search-query-language/search-operators#save-lookups-classic) with the save operator.  
