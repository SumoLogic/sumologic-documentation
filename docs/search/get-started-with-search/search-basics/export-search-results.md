...
:::note
To export search results, you must have a role that grants you the [Download Search Results](/docs/manage/users-roles/roles/role-capabilities/#data-management) capability.
:::
...
<img src={useBaseUrl('img/search/get-started-search/search-basics/export-search-results/exportaggregate.png')} alt="Export aggregate" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/search/get-started-search/search-basics/export-search-results/export-fields.png')} alt="Export fields" style={{border: '1px solid gray'}} width="200" />
