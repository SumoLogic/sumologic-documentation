...
See [Collecting Multiline Logs](../../../send-data/sources/reference-information/collect-multiline-logs.md) for information on caveats and your configuration options.
