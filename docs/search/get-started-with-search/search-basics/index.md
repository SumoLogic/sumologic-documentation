...
What do you need to know before you start typing a query? Sumo Logic search syntax and concepts use logical, familiar operators for writing accurate queries quickly.
...
<div className="box smallbox card">
  <div className="container">
  <a href={useBaseUrl('docs/search/get-started-with-search/search-basics/reference-field-special-characters')}><img src={useBaseUrl('img/icons/operations/advanced-search.png')} alt="Advanced Search icon" width="40"/><h4>Escape Special Characters in a Field Name</h4></a>
