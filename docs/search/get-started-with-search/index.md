...
<div className="box smallbox card">
  ...
  <img src={useBaseUrl('img/icons/search.png')} alt="Search icon" width="35"/><h4><a href={useBaseUrl('docs/search/get-started-with-search/search-basics')}>Search Basics</a></h4>
...
<div className="box smallbox card">
  <div className="container">
  <img src={useBaseUrl('img/icons/search.png')} alt="Search icon" width="35"/><h4><a href={useBaseUrl('docs/search/get-started-with-search/suggested-searches')}>Suggested Searches</a></h4>
