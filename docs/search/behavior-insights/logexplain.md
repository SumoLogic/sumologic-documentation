...
* [Time Compare](../time-compare.md) and the [compare operator](docs/search/search-query-language/operators#compare) are not supported against LogExplain results.
