...
* A Partition stores your data in an index separate from the rest of your account data so you can [optimize searches](optimize-search-performance.md), [manage variable retention](../manage/partitions-and-data-tiers/manage-indexes-variable-retention.md), and specify certain [data to forward to S3](../manage/data-forwarding/amazon-s3-bucket.md). See how to Run a [Search Against a Partition](optimizing-search-with-partitions.md).
...
* Archive allows you to forward log data from Installed Collectors to AWS S3 buckets to collect at a later time. See how to [Search ingested Archive data](../manage/archive.md)).
