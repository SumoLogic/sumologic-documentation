...
Logs collected by Sumo Logic are indexed in Partitions and Scheduled Views. In addition, there are internal indexes such as Account Events, Archive, Audit, and Volume indexes.
...
* Account Events monitor the health of your Collectors and Sources. See how to [Search Account Events](/docs/manage/account-events).
