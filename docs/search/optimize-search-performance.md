...
[**Partitions**](/docs/manage/partitions-and-data-tiers/index.md) route unstructured data into an index. See how to [Optimize Your Search with Partitions](optimizing-search-with-partitions.md).

[**Scheduled Views**](/docs/manage/scheduled-views/index.md) pre-aggregate data and then index it.
