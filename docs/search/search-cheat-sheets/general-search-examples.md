...
:::sumo More Info
For more information, see [Timeslice](docs/search/search-query-language/operators.md#timeslice) and [Transpose](../search-query-language/operators.md#transpose).
:::
