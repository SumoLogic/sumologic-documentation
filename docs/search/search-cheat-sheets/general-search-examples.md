...
:::sumo More Info
For more information, see [Timeslice](/docs/search/search-query-language/search-operators#timeslice) and [Transpose](/docs/searches/search-query-language/search-operators#transpose).
:::
