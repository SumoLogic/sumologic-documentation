...
1. <!--Kanso [**Classic UI**](/docs/get-started/sumo-logic-ui/). Kanso-->  We clicked the **+ New** button at the top of the screen and selected **Explore**. <!--Kanso <br/>[**New UI**](/docs/get-started/sumo-logic-ui-new/). In the main Sumo Logic menu, we selected **Infrastructure Monitoring > Kubernetes**. Kanso-->
