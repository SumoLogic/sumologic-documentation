...
1. [**Classic UI**](/docs/get-started/sumo-logic-ui-classic).  We clicked the **+ New** button at the top of the screen and selected **Explore**. <br/>[**New UI**](/docs/get-started/sumo-logic-ui). In the main Sumo Logic menu, we selected **Observability**, and then under **Infrastructure Monitoring** we selected **Kubernetes**. 
