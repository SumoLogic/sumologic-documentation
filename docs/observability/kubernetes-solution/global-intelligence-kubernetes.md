---
id: global-intelligence-kubernetes
---
...
This page has instructions for installing the Sumo App for Kubernetes DevOps and descriptions of each of the app dashboards. 
...
The infrastructure tab of the [Entity Inspector](/Visualizations-and-Alerts/Dashboard_(New)/Drill_down_to_discover_root_causes) is not compatible with Global Intelligence for Kubernetes DevOps and renders a blank page on Dashboards Summary for Kubernetes Deployment and Detail for Kubernetes Deployment. This is because Global Intelligence applications analyze anonymized customer data and do not have a way to identify customer entities required for Entity Inspector. 
