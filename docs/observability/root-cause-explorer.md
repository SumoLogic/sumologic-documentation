...
For information about Sumo Logic's CloudWatch source, see [Amazon CloudWatch Source for Metrics](../send-data/sources/sources-hosted-collectors/amazon-web-services/amazon-cloudwatch-source-metrics.md).
