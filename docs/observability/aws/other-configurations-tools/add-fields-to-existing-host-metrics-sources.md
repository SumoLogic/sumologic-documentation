...
| Prompt | Guideline |
|--|--|
| Sumo Logic Deployment Name | Enter au, ca, de, eu, jp, us2, in, fed or us1. For more information on Sumo Logic deployments, see the [Sumo Logic Endpoints and Firewall Security](/api/General-API-Information/Sumo-Logic-Endpoints-by-Deployment-and-Firewall-Security) topic. |
