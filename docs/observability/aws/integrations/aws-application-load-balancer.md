...
<img src={useBaseUrl('img/observability/alb2.png')} alt="AWS Application Load Balancer - Response Analysis dashboard" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/observability/alb3.png')} alt="AWS Application Load Balancer - Target Group Response Analysis dashboard" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/observability/alb4.png')} alt="AWS Application Load Balancer - Latency Overview dashboard" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/observability/alb5.png')} alt="AWS Application Load Balancer - Latency Details dashboard" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/observability/alb6.png')} alt="AWS Application Load Balancer - Connections and Host Status dashboard" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/observability/alb7.png')} alt="AWS Application Load Balancer - Requests and Processed Bytes dashboard" style={{border: '1px solid gray'}} width="800" />
...
<img src={useBaseUrl('img/observability/alb8.png')} alt="AWS Application Load Balancer - Threat Intel dashboard" style={{border: '1px solid gray'}} width="800" />
