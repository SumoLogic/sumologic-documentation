...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-Overview.png')} alt="AWS EC2 Cloudwatch Metrics Overview" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-Summary.png')} alt="AWS EC2 Cloudwatch Metrics Summary" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-CloudTrail-Events.png')} alt="AWS EC2 CloudTrail Events" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-CPU.png')} alt="AWS EC2 Cloudwatch Metrics CPU" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-EBS.png')} alt="AWS EC2 Cloudwatch Metrics EBS" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-Disk.png')} alt="AWS EC2 Cloudwatch Metrics Disk" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-Network.png')} alt="AWS EC2 Cloudwatch Metrics Network" width="800"/>
...
<img src={useBaseUrl('/img/observability/AWS-EC2-Cloudwatch-Metrics-Status-Check.png')} alt="AWS EC2 Cloudwatch Metrics Status Check" width="800"/>
