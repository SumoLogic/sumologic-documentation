...
<div className="box smallbox card">
  <div className="container">
  <a href={useBaseUrl('docs/observability/aws/integrations/global-intelligence-cloudtrail-devops')}><img src={useBaseUrl('img/integrations/amazon-aws/gi-devops.png')} alt="icon" width="50"/><h4>Global Intelligence for AWS CloudTrail DevOps</h4></a>
