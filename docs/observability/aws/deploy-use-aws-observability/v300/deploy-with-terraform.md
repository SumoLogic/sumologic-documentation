...
This will destroy all [resources](/docs/observability/aws/deploy-use-aws-observability/v300/resources/) and configuration previously set up.

## Migration Strategy from CloudWatch Source to Kinesis Firehose Source using Terraform

To migrate CloudWatch Source to Kinesis Firehose Source using Terraform, refer to [Migration Strategy from CloudWatch Source to Kinesis Firehose Source using Terraform](/docs/observability/aws/deploy-use-aws-observability/v300/migration-strategy-using-terraform).
...
:::note
To migrate from legacy CloudWatch Metrics Source to Kinesis Firehose Metrics Source using Terraform, refer to [Migration Strategy from CloudWatch Source to Kinesis Firehose Source using Terraform](/docs/observability/aws/deploy-use-aws-observability/v300/migration-strategy-using-terraform).
:::
...
:::note
To migrate CloudWatch Logs Source to Kinesis Firehose Logs Source using Terraform, refer to [Migration Strategy using Terraform](/docs/observability/aws/deploy-use-aws-observability/v300/migration-strategy-using-terraform).
:::
...
```
#### Solution
Refer to step 4 in this [section](/docs/observability/aws/deploy-use-aws-observability/v300/deploy-with-terraform/#step-2-configure-the-terraform-script).
...
- Refer to [Prerequisites](/docs/observability/aws/deploy-use-aws-observability/v300/before-you-deploy/#prerequisites) for permissions related issues.
