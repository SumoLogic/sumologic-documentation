...
For the latest CloudFormation template URL, see [Deploy with CloudFormation Template](/docs/observability/aws/deploy-use-aws-observability/v3.0.0/deploy-with-aws-cloudformation/#step-0-open-the-cloudformation-template). If you would like to download or inspect other versions, visit the [Changelog](/docs/observability/aws/deploy-use-aws-observability/changelog/) page.<br/><img src={useBaseUrl('img/observability/aws-create-stack.png')} alt="AWS create stack" style={{border: '1px solid gray'}} width="800" />
