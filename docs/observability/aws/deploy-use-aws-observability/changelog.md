...
|:--|:---------------|:--|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.15.0 | 28th May, 2026 | Yes | AWSO deployment is not supported in the AWS European Sovereign Cloud and Sumo Logic ESC environments due to the unavailability of the Serverless Application Repository.<br /><br />AWS Lambda runtime Node.js 22.x will be deprecated by AWS (Lambda Runtimes Documentation) on 30th Apr, 2027                         |
| 2.14.0 | 14th Apr, 2026 | Yes - Ends on 1st May, 2027 | AWSO is not supported in the AWS Zurich region, as the Serverless Application Repository is not available there.                                                                 |
| 2.13.0 | 7th Oct, 2025  | Yes - Ends on 1st May, 2027 | AWS Lambda runtime Node.js 22.x will be deprecated by AWS (Lambda Runtimes Documentation) on 30th Apr, 2027                                                                                                                                                                                 |
| 2.12.0 | 1st Apr, 2025  | Yes - Ends on 1st May, 2027 | AWS Lambda runtime Node.js 22.x will be deprecated by AWS (Lambda Runtimes Documentation) on 30th Apr, 2027                                                                                                                                                                                 |
| 2.11.0 | 24th Jan, 2025 | No | AWS Lambda runtime Node.js 20.x will be deprecated by AWS ([Lambda Runtimes Documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)) on 30th Apr, 2025 |
| 2.10.0 | 4th Sep, 2024  | No | AWS Lambda runtime Node.js 20.x will be deprecated by AWS ([Lambda Runtimes Documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)) on 30th Apr, 2025 |
| 2.9.0 | 2nd Aug, 2024  | No | AWS Lambda runtime Node.js 20.x will be deprecated by AWS ([Lambda Runtimes Documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)) on 30th Apr, 2025 |
