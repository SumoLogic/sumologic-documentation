...
| 2.11.0 | 24th Jan, 2025 | No | AWS Lambda runtime Node.js 20.x is deprecated by AWS ([Lambda Runtimes Documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)) on 30th Apr, 2025 |
| 2.10.0 | 4th Sep, 2024  | No | AWS Lambda runtime Node.js 20.x is deprecated by AWS ([Lambda Runtimes Documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)) on 30th Apr, 2025 |
| 2.9.0 | 2nd Aug, 2024  | No | AWS Lambda runtime Node.js 20.x is deprecated by AWS ([Lambda Runtimes Documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html)) on 30th Apr, 2025 |
