...
To resolve this issue, refer to [Creating Serverless Application Repository CloudFormation](/docs/observability/aws/deploy-use-aws-observability/v215/deploy-with-terraform/#troubleshooting).
