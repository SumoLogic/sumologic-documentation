...
The CloudFormation template creates a number of resources at deployment in AWS and Sumo Logic. You will use the template when setting up the solution. See [Before You Deploy](/docs/observability/aws/deploy-use-aws-observability/v215/before-you-deploy) for prerequisites and instructions to configure.
...
The [AWS CloudFormation](/docs/observability/aws/deploy-use-aws-observability/v215/deploy-with-aws-cloudformation) and [Terraform](/docs/observability/aws/deploy-use-aws-observability/v215/deploy-with-terraform) template execution creates the following resources in Sumo Logic.
