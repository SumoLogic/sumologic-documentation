---
slug: /observability/aws/deploy-use-aws-observability/v215/deploy-with-aws-cloudformation
...
If you are collecting AWS CloudTrail logs from multiple AWS accounts into a common S3 bucket, run the CloudFormation template in the account that has the S3 bucket and see [Centralized AWS CloudTrail Log Collection](/docs/observability/aws/deploy-use-aws-observability/v215/deploy-with-aws-cloudformation/centralized-aws-cloudtrail-log-collection/).
