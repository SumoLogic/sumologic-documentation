...
| Amazon RDS PostgreSQL - High Errors	| This alert fires when we detect Postgres logs show high rate (>10) of error/fatal logs over a 5 minutes time period | `>`10 | `<=`10 |
