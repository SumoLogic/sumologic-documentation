...
| Amazon ElastiCache - Multiple Failed Operations | This alert fires when we detect muliple failed operation within a 15 minutes interval for an ElastiCache service | >= 10 | < 10 |
