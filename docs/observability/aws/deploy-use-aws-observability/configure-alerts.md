...
| Amazon ElastiCache - Multiple Failed Operations | This alert fires when we detect multiple failed operation within a 15-minute interval for an ElastiCache service | >= 10 | < 10 |
