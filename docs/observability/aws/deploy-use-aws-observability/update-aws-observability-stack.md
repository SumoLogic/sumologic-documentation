...
1. Select **Replace Current Template** and paste the URL - https://sumologic-appdev-aws-sam-apps.s3.amazonaws.com/aws-observability-versions/v2.6.0/sumologic_observability.master.template.yaml in the Amazon S3 URL option and select **Next**.
    :::note
