...
* [AWS Observability Host Metrics (EC2)](docs/observability/aws/integrations/aws-ec2-host-metrics) - The Sumo Logic's app for AWS Observability Host Metrics (EC2) allows you to collect local host metrics and displays them using predefined search queries and dashboards for your [Amazon Elastic Compute Cloud (Amazon EC2)](https://aws.amazon.com/ec2/) service. App dashboards provide a visual analysis of local host metrics for CPU, Disk, Memory, Network, and TCP.
