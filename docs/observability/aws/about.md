...
* [AWS Observability RDS](/docs/observability/aws/integrations/aws-rds). The [Amazon Relational Database Service (RDS)](https://aws.amazon.com/rds/) allows you to easily set up, operate, and scale a relational database in your cloud infrastructure.
