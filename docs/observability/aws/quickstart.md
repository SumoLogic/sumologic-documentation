...
```
curl https://github.com/SumoLogic/sumologic-solution-templates/tree/master/aws-observability/scripts/AWSOAutoSetupScript/install.sh | bash -- <SUMO_ACCESS_ID> <SUMO_ACCESS_KEY>
```
