...
For example, the following example error `get_billing_info` on Lambda can pinpoint the exact error, logs, related services and entities, and potential cards of the following data:
...
You can [create dashboards](/docs/dashboards/create-dashboard-new) to analyze metric and log data in a single view, with the ability to quickly navigate through your data through graphs and data mappings to enable you to quickly identify issues and begin analysis.
