...
SLIs for Monitor-based SLOs are calculated at a granularity of 1 minute. One minute is treated as unsuccessful if a Monitor threshold is violated at any point of time within that minute.
