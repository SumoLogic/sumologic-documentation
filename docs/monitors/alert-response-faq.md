...
You can also force run the signature cataloging process manually, by calling the [LogCompare](../../../../05Search/LogCompare.md "LogCompare") or [LogReduce](/docs/search/logreduce) operators from the Log Search page. 
