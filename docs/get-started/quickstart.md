...
Kickstart Data is available for a maximum of 7 days. After this period, you'll need to begin ingesting your own data to continue using Sumo Logic.
...
4. **Seamless transition to real data**. Kickstart Data is available for 7 days. After that, you must set up your own data ingestion while continuing to use the platform’s core features. When your trial ends, Kickstart Data is deactivated automatically.
