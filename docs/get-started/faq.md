...
| IaaS / PaaS | <ul><li>Amazon</li><li>[Heroku](docs/manage/connections-and-integrations/sumo-logic-heroku.md)</li><li>Windows</li><li>[Google Audit](../cse/cse-ingestion/google-g-suite-apps-audit.md)</li><li>[Google Cloud Platform (GCP)](docs/send-data/hosted-collectors/google-source/google-cloud-platform-source.md)</li></ul> |
