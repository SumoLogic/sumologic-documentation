...
| IaaS / PaaS | <ul><li>Amazon</li><li>[Heroku](/docs/integrations/web-servers/heroku)</li><li>Windows</li><li>[Google Audit](/docs/cse/ingestion/ingestion-sources-for-siem/google-workspace-apps-audit/)</li><li>[Google Cloud Platform (GCP)](/docs/send-data/hosted-collectors/google-source/google-cloud-platform-source.md)</li></ul> |
