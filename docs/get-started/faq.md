...
| IaaS / PaaS | <ul><li>Amazon</li><li>[Heroku](docs/manage/connections-and-integrations/sumo-logic-heroku.md)</li><li>Windows</li><li>[Google Audit](../cse/ingestion/google-g-suite-apps-audit.md)</li><li>[Google Cloud Platform (GCP)](docs/send-data/hosted-collectors/google-source/google-cloud-platform-source.md)</li></ul> |
| SaaS | <ul><li>[Box](/docs/integrations/saas-cloud/Box)</li><li>[ServiceNow](docs/manage/connections-and-integrations/servicenow/set-up-servicenow-connections.md)</li><li>[Salesforce](/docs/integrations/saas-cloud/salesforce)</li><li>[Microsoft Office 365](/docs/integrations/microsoft-azure/office-365)</li></ul> |
