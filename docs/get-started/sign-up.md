...
1. Navigate to the Manage Plan section:
...
1. Choose one of the available Essentials plans:
   ...
   * **Orchestrate**. Designed for organizations requiring robust workflows and automation.<br/><img src={useBaseUrl('img/get-started/annuallanding-page.png')} alt="annual landing page" style={{border: '1px solid gray'}} width="800" /><br/>You'll also need to select a monthly or annual option.
    <details>
...
Once your payment has been processed, your account will be upgraded, and you’ll have immediate access to premium features.  
