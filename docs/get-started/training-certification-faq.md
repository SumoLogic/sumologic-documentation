...
2. From your **Home** page, click the **Learn** tab > **Learning Hub**.<br/><img src={useBaseUrl('img/get-started/learning-hub.png')} alt="Learning Hub" style={{border: '1px solid gray'}} width="700" />
3. You’ll land in the **Training** portal, where you can view onboarding tutorials, start self-paced classes, and more.

If the **Learning Hub** link isn't working, double-check that you've [verified your email address](#how-do-i-verify-my-email-address).
...
See the full catalog at [https://www.sumologic.com/learn/training#certified](https://www.sumologic.com/learn/training#certified) or from your Sumo Logic dashboard > **Get Certified**. Certifications include, but are not limited to:
...
Credentials change monthly. Go to the [Training portal](#how-do-i-access-the-training-portal) > **Become a Sumo Expert**.<br/><img src={useBaseUrl('img/get-started/lab-credentials.png')} alt="Training lab credentials" style={{border: '1px solid gray'}} width="600" />
...
* **Learning Paths** for General, Observability, and Security ([Training portal](#how-do-i-access-the-training-portal) > **Become a Sumo Expert**).
* **Micro Lessons** ([Training portal](#how-do-i-access-the-training-portal) > **Learn a New Skill**).
* **Recorded Live Training** sessions with lab guides and slides ([Training portal](#how-do-i-access-the-training-portal) > **Recorded Live Training**).
