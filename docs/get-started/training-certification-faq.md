...
2. Go to your [learning portal](#how-do-i-access-the-learning-portal) and click **Lab credentials** in the toolbar.<br/><img src={useBaseUrl('img/get-started/lab-credentials.png')} alt="Lab credentials self-service tool" style={{border: '1px solid gray'}} width="600" />
