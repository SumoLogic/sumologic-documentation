...
* Start logs with a regular format to make automatically detecting message boundaries easier. See [collecting multiline logs](../send-data/sources/sources-installed-collectors/define-boundary-regex-multiline-messages.md) for details.
...
| IaaS / PaaS | <ul><li>Amazon</li><li>[Heroku](../manage/connections-and-integrations/sumo-logic-heroku.md)</li><li>Windows</li><li>[Google Audit](../cse/cse-ingestion/google-g-suite-apps-audit.md)</li><li>[Google Cloud Platform (GCP)](../send-data/sources/sources-hosted-collectors/google-cloud-platform-source.md)</li></ul> |
