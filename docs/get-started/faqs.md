...
| IaaS / PaaS | <ul><li>Amazon</li><li>[Heroku] (/Manage/Connections-and-Integrations/Heroku-Add-On/Sumo-Logic-Add-on-for-Heroku)</li><li>Windows</li><li>[Google Audit] (/03Send-Data/Sources/02Sources-for-Hosted-Collectors/G-Suite-Apps-Audit-Source)</li><li>[Google Cloud Platform (GCP)] (/03Send-Data/Sources/02Sources-for-Hosted-Collectors/Google-Cloud-Platform-Source)</li></ul> |
| SaaS | <ul><li>[Box] (/07Sumo-Logic-Apps/18SAAS_and_Cloud_Apps/Box)</li><li>[ServiceNow] (/Manage/Connections-and-Integrations/ServiceNow/Set-Up-ServiceNow-Connections)</li><li>[Salesforce] (/07Sumo-Logic-Apps/18SAAS_and_Cloud_Apps/Salesforce)</li><li>[Microsoft Office 365] (/07Sumo-Logic-Apps/04Microsoft-and-Azure/Microsoft_Office_365)</li></ul> |
