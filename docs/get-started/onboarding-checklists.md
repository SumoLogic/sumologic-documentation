...
title: Onboarding Checklists for Analysts and Administrators
sidebar_label: Onboarding Checklists
---

import useBaseUrl from '@docusaurus/useBaseUrl';

Click each link below to go to each Help topic for all the details, then come back to this checklist to continue. To find your role (Administrator or Analyst), click your name in the left nav, then **Preferences**.

<img src={useBaseUrl('img/get-started/check-role.png')} alt="icon" width="550"/>
