...
There is a limit of ten pinned searches per user. Also, queries that use the [save operator](docs/search/search-query-language/search-operators#save-lookups-classic) cannot be pinned.
