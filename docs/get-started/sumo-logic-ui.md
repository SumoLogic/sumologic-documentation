...
Use the **Go To...** menu for quick access to settings, features, library content, monitors, SLOs, and search results. <img src={useBaseUrl('img/get-started/go-to-menu.png')} alt="Go To menu bar" style={{border: '1px solid gray'}} width="600"/>
...
| User needs to learn new way of organizing tabs. Managing multiple Sumo Logic instances is difficult. | User utilizes what they already know. Managing multiple Sumo Logic instances is easier. |
