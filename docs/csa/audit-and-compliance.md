...
Sumo Logic offers out-of-the-box apps for PCI compliance. To see the available PCI apps, select **App Catalog** and search for "PCI" in the search bar.

Each of the PCI compliance apps are designed for different data sources: AWS CloudTrail, Amazon VPC Flow, Linux, Palo Alto Networks, and Windows. You can install any of the apps yourself, or you can ask Sumo Logic professional services to set them up. All of these apps come with dashboards so you can quickly see whether your data currently meets PCI compliance requirements. 

### Perform a PCI compliance audit

This example shows how to use the PCI app for Palo Alto Networks to perform a PCI audit.

#### Step 1: Install the PCI app

Perform the steps needed to collect logs and install the app. Select the app for the version of Palo Alto Networks you use:
...
### Step 2: Use the PCI app for compliance

In this step, we’ll use the dashboards in the app to make sure data meets Requirement 4: "Encrypt transmission of cardholder data across open, public networks."
