...
Collector Release Notes from Jan 1, 2022 - Sept 26, 2022 are listed here. To view Release Notes Sept 26, 2022 to present, [click here](/release-notes-collector). To view Release Notes from previous years, see the [archive](/docs/releasenotesarchive).
