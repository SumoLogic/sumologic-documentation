...
Service Release Notes (metrics, apps, traces, observability, search, and more) for Jan 1, 2022 - Oct 7, 2022 are listed here.

To view Release Notes Oct 7, 2022 to present, [click here](/release-notes-service). To view Release Notes from previous years, check the [archive](/docs/releasenotesarchive).
