...
This page provides instructions for configuring log and metric collection for the Sumo Logic App for Cassandra. Configuring log and metric collection for the Cassandra App includes the following tasks:
