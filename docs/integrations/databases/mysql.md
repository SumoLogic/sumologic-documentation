...
2. Select the version of the service you're using and click **Add to Library**. Version selection is applicable only to a few apps currently. For more information, see the [Install the Apps from the Library.](docs/get-started/library/index.md/Apps-in-Sumo-Logic/Install-Apps-from-the-Library)
