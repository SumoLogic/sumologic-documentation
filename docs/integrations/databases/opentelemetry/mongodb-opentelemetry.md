...
:::info
This app includes [built-in monitors](#mongodb-alerts). For details on creating custom monitors, refer to [Create monitors for MongoDB app](#create-monitors-for-mongodb-app).
:::
