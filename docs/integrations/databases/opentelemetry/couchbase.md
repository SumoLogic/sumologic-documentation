---
id: opentelemetry-couchbase
title: Couchbase - OpenTelemetry Collector
sidebar_label: Couchbase - OTel Collector
description: Documentation for OpenTelemetry App for Couchbase.
---
...
<img src={useBaseUrl('img/integrations/databases/couchbase-logo.png')} alt="Thumbnail icon" width="75"/> <img src={useBaseUrl('img/send-data/otel-color.svg')} alt="Thumbnail icon" width="45"/>
...
The Sumo Logic app for Couchbase helps you monitor activity in Couchbase. The pre-configured dashboards provide insight into the Error, events and HTTP Access patter that help you understand your clusters.
