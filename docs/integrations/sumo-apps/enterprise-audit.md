...
* [Enterprise Audit - User & Role Management App](https://help.sumologic.com/07Sumo-Logic-Apps/26Apps_for_Sumo/Enterprise_Audit_Apps/Install_the_Enterprise_Audit_Apps_and_View_the_Dashboards#Enterprise_Audit_-_User_.26_Role_Management_App) provides visibility on user activities such as creating, deleting, and modifying user roles, email account, and password changes. You can also review various user session data.
* [Enterprise Audit - Security Management App](https://help.sumologic.com/07Sumo-Logic-Apps/26Apps_for_Sumo/Enterprise_Audit_Apps/Install_the_Enterprise_Audit_Apps_and_View_the_Dashboards#Enterprise_Audit_-_Security_Management_App) provides visibility into security posture, such as Access Key Activities, SAML Activities, Password Policy, Multi-Factor Authorization (MFA), and Service AllowList activities within your Sumo Logic Environment.
...
The Audit Event Index is enabled by default, and _only_ available for Trial and Enterprise accounts.
...
### Enterprise Audit - Collector Management Overview Dashboard
...
### Enterprise Audit - Collector Activities Dashboard
...
### Enterprise Audit - Collector Sources Activities Dashboard
...
### Enterprise Audit - Data Forwarding Management Overview Dashboard
...
### Enterprise Audit - Data Forwarding Destination Activities Dashboard
...
### Enterprise Audit - Data Forwarding Index Activities Dashboard
...
### Enterprise Audit - Content Management Overview Dashboard
...
### Enterprise Audit - Created, Deleted, Exported, Imported Content Dashboard
...
### Enterprise Audit - Updated, Moved, Copied Content Dashboard
...
### Enterprise Audit - Permission Updated, Synchronized Content Dashboard
...
### Enterprise Audit - Publicly Accessed, Application Installed Dashboard
...
### Enterprise Audit - Field Extraction Rule Activities Dashboard
...
### Enterprise Audit - User & Role Management Overview Dashboard
...
### Enterprise Audit - User Activities Dashboard
...
### Enterprise Audit - Role Activities Dashboard
...
### Enterprise Audit - User Session Activities Dashboard
...
### Enterprise Audit - User Role Relationship Activities Dashboard
...
### Enterprise Audit - Security Management Overview Dashboard
...
### Enterprise Audit - Password Policy, MFA, Service AllowList Activities Dashboard
...
### Enterprise Audit - Access Key Activities Dashboard
...
### Enterprise Audit - SAML Activities Dashboard
