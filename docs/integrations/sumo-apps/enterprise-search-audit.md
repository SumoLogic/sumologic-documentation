...
Enable the Search Audit index (`_view = sumologic_search_usage_per_query`) prior installation. See [Enable the Search Audit Index](/docs/manage/security/audit-indexes/search-audit-index/#enable-the-search-audit-index) for instructions.
