---
id: cse
title: Sumo Logic Cloud SIEM Enterprise App
sidebar_label: Cloud SIEM Enterprise
description: The CSE app gives you visibility into what’s going on in Cloud SIEM Enterprise
---
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Insights-Closed.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Insights-Created.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Insights-Overview.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Rules-And-Mapping-Changes.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Signal-Analysis.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Signal-Analysis-Rules.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Signal-Monitoring.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Signals-Overview.png')} alt="CSE dashboard" />
...
<img src={useBaseUrl('img/integrations/sumo-apps/CSE-Signals-by-Product.png')} alt="CSE dashboard" />
