...
:::info
Sumo Logic also supports [Snyk Automation Service Integration](/docs/platform-services/automation-service/app-central/integrations/snyk/) to automate response actions directly from Cloud SIEM or Cloud SOAR playbooks.
:::
