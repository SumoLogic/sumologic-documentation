...
id: squadcast
title: Squadcast
description: Learn about the collection process for the Squadcast integration.
---
...
This section has instructions for collecting logs for the Sumo Logic's Squadcast webhook collection.
...
2. Configure **Source Category** in the HTTP Source. For example, configure as `webhook/squadcast` for the Squadcast integration.
...
2. Go to **Settings**, and click on **Webhooks**.
3. Click on **Add Webhook**. The webhook form will appear.
4. Enter webhook form data as follows:
    - **Webhook Name**. Provide a name for your outgoing webhook.
    - **URL**. Enter the Sumo Logic HTTP endpoint URL(source address) created above.
5. Click on **Next: Choose Webhook Type**. Next page of webhook configuration will appear.
...
6. Click on **Next: Configure Payload**. Next page of webhook configuration will appear.
...
:::info
- For detailed information about webhook creation, refer [Squadcast Documentation](https://support.squadcast.com/integrations/outgoing-webhooks).
