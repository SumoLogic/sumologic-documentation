...
:::note
Sumo Logic latest Jenkins plugin is certified against java 21 with Jenkins versions 2.516.2. It requires jenkins to run on java 11 ,17 or 21 and minumum jenkins version of 2.426.3.
