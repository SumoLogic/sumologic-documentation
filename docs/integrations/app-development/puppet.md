...
7. **Source Category**. (Required) Enter ta value like: \
...
This is a partial Puppet report in YAML format.
...
This is a partial Puppet report in JSON format.
...
## Install the Puppet App and View the Dashboards
