...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/saleforce.png')} alt="Thumbnail icon" width="100"/>
...
4. You may do the configuration steps on a  system with a web browser for authentication via OAuth2, and then move the configuration folder to your production system. Or if your production system has a web browser, all steps may be done on that system.
...
4. Remove the `sf_readfiles.dat` file that was just created. This file should be located under the `data` folder.
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/Salesforce-Overview.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/sf-APEX-APIPerformance.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/sf-Logins.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/ReportPerformance.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/SetupAuditActivity.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/UserActivityContent.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/UserActivityMonitoring.png')} alt="SalesForce dashboards" />
...
<img src={useBaseUrl('img/integrations/saas-cloud-apps/UserAgent.png')} alt="SalesForce dashboards" />
