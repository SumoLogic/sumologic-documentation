...
* [Log types](https://help.sumologic.com/07Sumo-Logic-Apps/18SAAS_and_Cloud_Apps/Box/01-Collect-Events-for-the-Box-App#Log_types)
...
The Sumo Logic App for Box collects Box events, which are described in detail in the [Box documentation](https://developers.box.com/docs#events).
