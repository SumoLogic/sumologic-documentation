...
1. Follow the instructions for [Configuring a Hosted Collector in Sumo Logic to start collecting logs](https://help.sumologic.com/03Send-Data/Hosted-Collectors/Configure-a-Hosted-Collector).
