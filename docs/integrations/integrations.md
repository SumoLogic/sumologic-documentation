...
<div className="box box2 card">
  ...
  <p>A guide to Sumo Logic apps for Microsoft and Azure.</p>
    ...
    <div className="box box3 card">
      <div className="container">
      <img src={useBaseUrl('img/integrations/google/google.png')} alt="DB icon" width="50"/>
    ...
    <div className="box box4 card">
      <div className="container">
      <img src={useBaseUrl('img/integrations/databases/databases-icon.png')} alt="DB icon" width="70"/>
    ...
    <div className="box box5 card">
      <div className="container">
      <img src={useBaseUrl('img/integrations/containers-orchestration/containers.png')} alt="DB icon" width="50"/>
