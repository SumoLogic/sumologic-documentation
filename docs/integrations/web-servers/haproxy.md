...
```bash title="Kubernetes environment"
{
...
```bash title="Non-Kubernetes environment"
...
This query example is from **Top 5 Clients causing Errors** panels from **HAProxy - Overview** dashboard.
  ```
