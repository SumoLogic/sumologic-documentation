...
<div className="box smallbox card">
  ...
  <a href={useBaseUrl('docs/integrations/web-servers/opentelemetry')}><img src={useBaseUrl('img/send-data/otel-color.svg')} alt="Thumbnail icon" width="55"/><h4>OpenTelemtry</h4></a>
