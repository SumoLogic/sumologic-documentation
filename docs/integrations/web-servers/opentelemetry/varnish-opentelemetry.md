...
<img src={useBaseUrl('img/integrations/web-servers/varnish-cache.png')} alt="Varnish Cache icon" width="75"/> <img src={useBaseUrl('img/send-data/otel-color.svg')} alt="OpenTelemetry color icon" width="45"/>
