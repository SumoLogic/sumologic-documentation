...
- Use the [Vectra Automation Service Integration](/docs/platform-services/automation-service/app-central/integrations/vectra/) to automate response actions directly from Cloud SOAR playbooks.