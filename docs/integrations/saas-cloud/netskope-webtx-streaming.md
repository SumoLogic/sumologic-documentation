...
| `Netskope WebTx Streaming - Unauthorized Access Attempts`                                   | Tracks unauthorized access attempts (401/403) in web transactions, highlighting unusually frequent failures across users/devices for timely investigation.                                                                                                                               | Critical                                        | Count > 2       |
