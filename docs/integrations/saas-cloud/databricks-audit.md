...
|:--|:--|:--|:--|
| `Databricks Audits - Audits from Embargoed Geo Locations` | This alert is triggered when audit logs are generated from sanctioned or embargoed regions, helping maintain compliance with legal and regulatory requirements. | Critical | Count > 0 | 
