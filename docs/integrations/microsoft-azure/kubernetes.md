...
| `Azure Kubernetes Service - Node Disk Usage %`                                                                                                  | This alert is triggered with critical type when node disk usage % is greater than 80% and trigger with type warning when greater than 70%.                               | percentage >= 80  | percentage < 80   |
