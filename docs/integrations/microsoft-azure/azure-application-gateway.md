...
The **Azure Application Gateway - Audit Control Plane Operations** dashboard provides details like changes, changes by operations, top 10 operations that caused the most errors, and count by user operations.
