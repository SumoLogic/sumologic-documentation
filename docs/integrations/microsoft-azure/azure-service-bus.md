...
<img src={useBaseUrl('img/integrations/microsoft-azure/azure-service-bus.png')} alt="Azure Service Bus icon" width="50"/>
...
| `Azure Service Bus - High Count of Messages (Overall)` | This alert is triggered when the messages count (active, dead-lettered, scheduled) is greater than 5000. | Count > 5000 | Count < = 5000 |
