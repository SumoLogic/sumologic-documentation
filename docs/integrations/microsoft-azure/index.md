...
<div className="box smallbox card">
  <div className="container">
  <a href={useBaseUrl('docs/integrations/microsoft-azure/microsoft-defender-for-cloud')}><img src={useBaseUrl('img/integrations/microsoft-azure/microsoft-defender-for-cloud.png')} alt="thumbnail icon" width="75"/><h4>Microsoft Defender for Cloud</h4></a>
