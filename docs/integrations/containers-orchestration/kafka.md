...
<img src={useBaseUrl('img/integrations/containers-orchestration/kafka.png')} alt="Kafka icon" width="150"/>
...
<img src={useBaseUrl('img/integrations/containers-orchestration/kafka-k8s.png')} alt="Kafka Kubernetes" />
