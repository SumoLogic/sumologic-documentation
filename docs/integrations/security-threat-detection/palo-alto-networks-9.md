...
Configuring log collection for Palo Alto Networks 9 includes the following tasks:
...
1. Log in to Sumo Logic and create a [Hosted Collector](https://help.sumologic.com/03Send-Data/Hosted-Collectors/Configure-a-Hosted-Collector).
...
5. In the **Servers** window, specify the following information:
   ...
   * **Port**: Port from [Step 1](https://help.sumologic.com/07Sumo-Logic-Apps/22Security_and_Threat_Detection/Palo_Alto_Networks_9/Collect_logs_for_the_Palo_Alto_Networks_9_App#Step_1._Create_a_hosted_collector_and_Cloud_Syslog_source)
    * **Format**: `IETF`
    * **Facility**: `LOG_USER`
6. In the **Syslog Server Profile** window, select the **Custom Log Format** tab, and use the following custom format for the following log types. In each code snippet, you'll need your token from [Step 1](/docs/integrations/security-threat-detection/palo-alto-networks-9#step-1-create-a-hosted-collector-and-cloud-syslog-source).
...
1. [System](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/system-log-fields.html) Logs
2. [Configuration](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/config-log-fields.html) Logs
3. [USERID](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/user-id-log-fields.html) Logs
4. [HIPMatch](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/hip-match-log-fields.html) Logs
5. [Traffic](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/traffic-log-fields.html) Logs
6. [Threat](https://docs.paloaltonetworks.com/pan-os/9-0/pan-os-admin/monitoring/use-syslog-for-monitoring/syslog-field-descriptions/threat-log-fields.html) Logs
...
## Install the Palo Alto Networks 9 App and view the Dashboards
...
### Palo Alto Networks 9 - HIPMatch Monitoring
39
...
### Palo Alto Networks 9 - System Monitoring
41
