...
Follow the instructions for setting up [Cloud to Cloud Integration for SailPoint App](https://help.sumologic.com/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/sailpoint-source/) to create the source and use the same source category while installing the app.
