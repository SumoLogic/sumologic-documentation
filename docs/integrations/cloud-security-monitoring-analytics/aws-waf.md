...
- Use the [AWS WAF Automation Service Integration](/docs/platform-services/automation-service/app-central/integrations/aws-waf/) to automate response actions directly from Cloud SOAR playbooks.