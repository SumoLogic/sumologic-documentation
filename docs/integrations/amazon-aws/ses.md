...
<img src={useBaseUrl('img/integrations/amazon-aws/ses.png')} alt="DB icon" width="50"/>
...
2. [Grant Sumo Logic access](https://help.sumologic.com/03Send-Data/Sources/02Sources-for-Hosted-Collectors/Amazon-Web-Services/Grant-Access-to-an-AWS-Product) to the Amazon S3 bucket created or selected above.
