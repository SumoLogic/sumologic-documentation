...
2. [Grant Sumo Logic access](/docs/send-data/sources/hosted-collectors/amazon-aws/grant-access-aws-product.md) to the Amazon S3 bucket created or selected above.
