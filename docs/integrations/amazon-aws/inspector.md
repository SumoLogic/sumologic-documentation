...
1. [Grant Access to an AWS S3 Bucket.](/docs/send-data/sources/hosted-collectors/amazon-aws/grant-access-aws-product.md)
...
3. Add an [AWS Source](/docs/send-data/Sources/hosted-collectors/amazon-aws/AWS-S3-Source#AWS_Sources) for the S3 Source to Sumo Logic, and in **Advanced Options for Logs**, under Timestamp Format, click **Specify a format** and enter the following:
