...
Enable Elastic Load Balancing logging in your AWS account and configure a Sumo Logic ELB Source, using [these instructions](/docs/send-data/Sources/hosted-collectors/amazon-aws/AWS-Elastic-Load-Balancing-Source).
