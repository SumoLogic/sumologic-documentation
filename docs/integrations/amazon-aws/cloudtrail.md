...
1. Add an [AWS CloudTrail Source](/docs/send-data/sources/hosted-collectors/amazon-aws/aws-cloudtrail-source.md) to Sumo Logic.
2. [Grant Sumo Logic access](/docs/send-data/sources/hosted-collectors/amazon-aws/grant-access-aws-product.md) to an Amazon S3 bucket.
  ...
  * Copy the Role ARN from the Outputs tab and paste it in the Role ARN field in Sumo Logic CloudTrail Source created in step 3. For more information, refer [Configuring your AWS source with CloudFormation](/docs/send-data/Sources/hosted-collectors/amazon-aws/configure-our-aws-source-cloudformation#set-up-an-iam-role).
