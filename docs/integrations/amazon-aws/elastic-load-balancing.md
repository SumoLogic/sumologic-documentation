...
Configure an [AWS Elastic Load Balancing Source](/docs/send-data/Sources/hosted-collectors/Amazon-Web-Services/AWS-Elastic-Load-Balancing-Source), which includes specifying the following:
