...
:::note
We recommend not to set `log_statement` to any value other than none (default value). Since it will interfere with slow query logs and ingestion will increase significantly.
:::
