...
:::info
Sumo Logic also supports [AWS Private Certificate Authority Automation Service Integration](/docs/platform-services/automation-service/app-central/integrations/aws-private-certificate-authority/) to automate response actions directly from Cloud SIEM or Cloud SOAR playbooks.
:::
