...
3. [Grant Sumo Logic Access to the AWS S3 Bucket](/docs/send-data/sources/hosted-collectors/amazon-aws/grant-access-aws-product.md).


### Configure a Collector

In Sumo Logic, configure a [Hosted Collector](/docs/send-data/configure-hosted-collector).
