...
In Sumo Logic, configure a [Hosted Collector](https://help.sumologic.com/03Send-Data/Hosted-Collectors/Configure-a-Hosted-Collector).
...
3. Complete steps 10.B through 10.E for [configuring SNS Notifications](https://help.sumologic.com/07Sumo-Logic-Apps/01Amazon_and_AWS/Amazon_S3_Audit_App/01-Collect-logs-for-the-Amazon-S3-Audit-App#Configure+SNS+Notifications).
...
2. Verify you have enabled sending **Notifications** from your S3 bucket to the appropriate SNS topic. This is done in [step 10.E](https://help.sumologic.com/07Sumo-Logic-Apps/01Amazon_and_AWS/Amazon_S3_Audit_App/01-Collect-logs-for-the-Amazon-S3-Audit-App#Configure+SNS+Notifications).
...
2. Verify you have enabled sending **Notifications** from your S3 bucket to the appropriate SNS topic. This is done in [step 10](https://help.sumologic.com/07Sumo-Logic-Apps/01Amazon_and_AWS/Amazon_S3_Audit_App/01-Collect-logs-for-the-Amazon-S3-Audit-App#Configure+SNS+Notifications).
