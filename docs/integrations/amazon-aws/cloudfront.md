...
3. Complete steps 10.B through 10.E for [configuring SNS Notifications](https://help.sumologic.com/07Sumo-Logic-Apps/01Amazon_and_AWS/Amazon_CloudFront/01-Collect-Logs-for-the-Amazon-CloudFront-App#Configure+SNS+Notifications).
...
2. Verify you have enabled sending **Notifications** from your S3 bucket to the appropriate SNS topic. This is done in [step 10.E](https://help.sumologic.com/07Sumo-Logic-Apps/01Amazon_and_AWS/Amazon_CloudFront/01-Collect-Logs-for-the-Amazon-CloudFront-App#Configure+SNS+Notifications).
...
2. Verify you have enabled sending **Notifications** from your S3 bucket to the appropriate SNS topic. This is done in [step 10](https://help.sumologic.com/07Sumo-Logic-Apps/01Amazon_and_AWS/Amazon_CloudFront/01-Collect-Logs-for-the-Amazon-CloudFront-App#Configure+SNS+Notifications).
