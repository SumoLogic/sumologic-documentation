...
<div className="box smallbox card">
  ...
  <h4><a href={useBaseUrl('docs/integrations/amazon-aws/aws-amplif')}>AWS Amplify</a></h4>
...
<div className="box smallbox card">
  ...
  <h4><a href={useBaseUrl('docs/integrations/amazon-aws/aws-private-certificate-authorit')}>AWS Private Certificate Authority</a></h4>
...
<div className="box smallbox card">
  ...
  <p>A guide to the Sumo Logic app for Amazon ElastiCache.</p>
    ...
    <h4><a href={useBaseUrl('docs/integrations/amazon-aws/elastic-container-service')}>Amazon ECS</a></h4>
...
<div className="box smallbox card">
  <div className="container">
  <img src={useBaseUrl('img/integrations/amazon-aws/ecs.png')} alt="Thumbnail icon" width="50"/>
  <h4><a href={useBaseUrl('docs/integrations/amazon-aws/elastic-container-service-container-insights-cloudwatch')}>Amazon ECS CW</a></h4>
  <p>A guide to our app for Amazon ECS CloudWatch.</p>
    ...
    <div className="box smallbox card">
        ...
        <h4><a href={useBaseUrl('docs/integrations/amazon-aws/guarddut')}>Amazon GuardDuty</a></h4>
      ...
      <div className="box smallbox card">
        <div className="container">
        <img src={useBaseUrl('img/integrations/amazon-aws/guardduty-benchmark.png')} alt="Thumbnail icon" width="50"/>
        <h4><a href={useBaseUrl('docs/integrations/amazon-aws/global-intelligence-guardduty')}>GI for Amazon GuardDuty</a></h4>
      ...
      <div className="box smallbox card">
        ...
        <div className="box smallbox card">
          ...
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/vpc-flow-logs')}>VPC Flow Logs</a></h4>
        ...
        <div className="box smallbox card">
          ...
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/vpc-flow-logs-pci-compliance')}>PCI Compliance - VPC Flow Logs</a></h4>
        ...
        <div className="box smallbox card">
          ...
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/api-gatewa')}>AWS API Gateway</a></h4>
        ...
        <div className="box smallbox card">
          ...
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/application-load-balancer')}>AWS ALB</a></h4>
        ...
        <div className="box smallbox card">
          ...
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/global-intelligence-cloudtrail-secops')}>GI for AWS CloudTrail SecOps</a></h4>
        ...
        <div className="box smallbox card">
          ...
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/global-intelligence-cloudtrail-devops')}>GI for AWS CloudTrail DevOps</a></h4>
        ...
        <div className="box smallbox card">
          <div className="container">
          <img src={useBaseUrl('img/integrations/amazon-aws/alb.png')} alt="Thumbnail icon" width="50"/>
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/elastic-load-balancing')}>AWS Elastic Load Balancing</a></h4>
        ...
        <div className="box smallbox card">
          <div className="container">
          <img src={useBaseUrl('img/integrations/amazon-aws/security-qs.png')} alt="Thumbnail icon" width="50"/>
          <h4><a href={useBaseUrl('docs/integrations/amazon-aws/security-hub')}>AWS Security Hub</a></h4>
    ...
    <div className="container">
    <img src={useBaseUrl('img/integrations/amazon-aws/waf.png')} alt="Thumbnail icon" width="50"/>
    <h5><a href={useBaseUrl('docs/integrations/amazon-aws/cis-aws-foundations-benchmark')}>CIS AWS Foundations Benchmark App</a></h5>
  ...
  <div className="box smallbox card">
    <div className="container">
    <img src={useBaseUrl('img/integrations/amazon-aws/waf.png')} alt="Thumbnail icon" width="50"/>
    <h4><a href={useBaseUrl('docs/integrations/amazon-aws/threat-intel')}>AWS Foundations Benchmark App</a></h4>
