...
<div className="box smallbox1 card">
  ...
  <p>A guide to the Sumo Logic app for AWS Amplify.</p>
  </div>
</div>
...
<div className="box smallbox4 card">
  ...
  <h4><a href="/docs/integrations/amazon-aws/dynamodb">Amazon DynamoDB</a></h4>
  ...
  <div className="box smallbox6 card">
    ...
    <img src={useBaseUrl('img/integrations/amazon-aws/eks.png')} alt="Thumbnail icon" width="50"/>
      <h4><a href="/docs/integrations/amazon-aws/eks-control-plane">Amazon EKS - Control Plane</a></h4>
  ...
  <p>A guide to the Sumo Logic app for Amazon ElastiCache.</p>
    ...
    <h4><a href="/docs/integrations/amazon-aws/elastic-container-service">Amazon ECS</a></h4>
...
<div className="box smallbox9 card">
  ...
  <p>A guide to our app for Amazon ECS CloudWatch.</p>
    ...
    <div className="box smallbox10 card">
        ...
        <h4><a href="/docs/integrations/amazon-aws/guardduty">Amazon GuardDuty</a></h4>
      ...
      <div className="box smallbox12 card">
        <div className="container">
        <img src={useBaseUrl('img/integrations/amazon-aws/guardduty-benchmark.png')} alt="Thumbnail icon" width="50"/>
        <h4><a href="/docs/integrations/amazon-aws/global-intelligence-guardduty">GI for Amazon GuardDuty</a></h4>
      ...
      <div className="box smallbox13 card">
        ...
        <h4><a href="/docs/integrations/amazon-aws/inspector">Amazon Inspector</a></h4>
      ...
      <div className="box smallbox14 card">
        ...
        <h4><a href="/docs/integrations/amazon-aws/inspector-classic">Amazon Inspector App Classic</a></h4>
      ...
      <div className="box smallbox17 card">
        ...
        <h4><a href="/docs/integrations/amazon-aws/rds">Amazon RDS</a></h4>
      ...
      <div className="box smallbox20 card">
        ...
        <h4><a href="/docs/integrations/amazon-aws/s3-audit">Amazon S3 Audit</a></h4>
      ...
      <div className="box smallbox21 card">
        ...
        <p>A guide to our Security QuickStart app.</p>
          ...
          <h4><a href="/docs/integrations/amazon-aws/ses">Amazon SES</a></h4>
        ...
        <div className="box smallbox23 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/sns">Amazon SNS</a></h4>
        ...
        <div className="box smallbox24 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/sqs">Amazon SQS</a></h4>
        ...
        <div className="box smallbox27 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/api-gateway">AWS API Gateway</a></h4>
        ...
        <div className="box smallbox30 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/cloudtrail">AWS CloudTrail</a></h4>
        ...
        <div className="box smallbox31 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/global-intelligence-cloudtrail-secops">GI for AWS CloudTrail SecOps</a></h4>
        ...
        <div className="box smallbox34 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/config">AWS Config</a></h4>
        ...
        <div className="box smallbox35 card">
          ...
          <h4><a href="/docs/integrations/amazon-aws/cost-explorer">AWS Cost Explorer</a></h4>
