...
<img src={useBaseUrl('img/integrations/google/GoogleCloudSpanner.png')} alt="Google Cloud Spanner icon" width="50"/>
...
* Collect **GCP Metrics** using the [GCP Metric](/docs/send-data/hosted-collectors/google-source/gcp-metrics-source/) source. Under the **Services** dropdown, select **Spanner**. For Google Spanner metrics and dimensions, refer to [Google Spanner metrics](https://cloud.google.com/monitoring/api/metrics_gcp#gcp-spanner).
