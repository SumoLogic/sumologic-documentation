...
In this step you export Google Cloud Load Balancing logs to the Pub/Sub topic you created in the previous step.
...
1. For resource_type, replace `<resource_variable>` with `http_load_balancer`.


12


1. In the **Edit Export** pane on the right:
