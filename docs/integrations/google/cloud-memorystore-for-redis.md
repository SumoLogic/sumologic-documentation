...
* Collect **GCP Metrics** using the [GCP Metric](/docs/send-data/hosted-collectors/google-source/gcp-metrics-source/) source. Make sure that you select **Cloud Memorystore for Redis** from the **Services** dropdown. For Google Memorystore for Redis metrics and dimensions, refer to [Google Memorystore for Redis metrics](https://cloud.google.com/monitoring/api/metrics_gcp#gcp-redis).