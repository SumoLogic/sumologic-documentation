...
<img src={useBaseUrl('img/integrations/google/GoogleCloudDataproc.png')} alt="Google Cloud Dataproc icon" width="50"/>
...
* Collect **GCP Metrics** using the [GCP Metric](/docs/send-data/hosted-collectors/google-source/gcp-metrics-source/) source. Under the **Services** dropdown, select **Cloud Dataproc**. For Google Dataproc metrics and dimensions, refer to [Google Dataproc metrics](https://cloud.google.com/monitoring/api/metrics_gcp#gcp-dataproc).
