...
* Collect **GCP Metrics** using the [GCP Metric](/docs/send-data/hosted-collectors/google-source/gcp-metrics-source/) source. Note that in the Services dropdown, you'll need to select **Pub/Sub**. For Google PubSub metrics and dimensions, refer to [Google PubSub metrics](https://cloud.google.com/monitoring/api/metrics_gcp#gcp-pubsub).