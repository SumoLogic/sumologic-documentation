...
<div className="box-wrapper" >
  ...
  <div className="box smallbox card">
    <div className="container">
    <a href={useBaseUrl('docs/integrations/google/cloud-api-gateway')}><img src={useBaseUrl('img/integrations/google/GoogleCloudAPIGateway.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud API Gateway</h4></a>
    <p>A guide to the Sumo Logic app for Google Cloud API Gateway.</p>
    </div>
  </div>
  <div className="box smallbox card">
    <div className="container">
    <a href={useBaseUrl('docs/integrations/google/cloud-apis')}><img src={useBaseUrl('img/integrations/google/GoogleCloudAPIs.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud APIs</h4></a>
  ...
  <div className="box smallbox card">
    <div className="container">
    <a href={useBaseUrl('docs/integrations/google/cloud-run')}><img src={useBaseUrl('img/integrations/google/GoogleCloudRun.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud Run</h4></a>
  ...
  <div className="box smallbox card">
    <div className="container">
    <a href={useBaseUrl('docs/integrations/google/cloud-tasks')}><img src={useBaseUrl('img/integrations/google/GoogleCloudTasks.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud Tasks</h4></a>
    <p>A guide to the Sumo Logic app for Google Cloud Tasks.</p>
    </div>
  </div>
  <div className="box smallbox card">
    <div className="container">  
    <a href={useBaseUrl('docs/integrations/google/cloud-tpu')}><img src={useBaseUrl('img/integrations/google/GoogleCloudTPU.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud TPU</h4></a>
    <p>A guide to the Sumo Logic app for Google Cloud TPU.</p>
    </div>
  </div>
  <div className="box smallbox card">
    <div className="container">  
    <a href={useBaseUrl('docs/integrations/google/cloud-trace')}><img src={useBaseUrl('img/integrations/google/GoogleCloudTrace.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud Trace</h4></a>
    <p>A guide to the Sumo Logic app for Google Cloud Trace.</p>
    </div>
  </div>
  <div className="box smallbox card">
    <div className="container">  
    <a href={useBaseUrl('docs/integrations/google/cloud-traffic-director')}><img src={useBaseUrl('img/integrations/google/GoogleCloudTrafficDirector.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud Traffic Director</h4></a>
    <p>A guide to the Sumo Logic app for Google Cloud Traffic Director.</p>
    </div>
  </div>
  <div className="box smallbox card">
    <div className="container">  
    <a href={useBaseUrl('docs/integrations/google/cloud-vertex-ai')}><img src={useBaseUrl('img/integrations/google/GoogleCloudVertexAI.png')} alt="Thumbnail icon" width="55"/><h4>Google Cloud Vertex AI</h4></a>
  ...
  <div className="box smallbox card">
    <div className="container">
      <a href={useBaseUrl('docs/integrations/google/compute-engine')}><img src={useBaseUrl('img/integrations/google/ce.png')} alt="Thumbnail icon" width="50"/><h4>Google Compute Engine</h4></a>
