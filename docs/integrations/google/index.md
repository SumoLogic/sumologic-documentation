...
<div className="box smallbox1 card">
  ...
  <h4><a href="/docs/integrations/google/">Google App Engine</a></h4>
...
<div className="box smallbox2 card">
  ...
  <h4><a href="/docs/integrations/google/">Google BigQuery</a></h4>
  <p>A guide to the Sumo Logic app for Google BigQuery.</p>
    ...
    <div className="box smallbox3 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud Audit</a></h4>
    ...
    <div className="box smallbox4 card">
      ...
      <h4><a href="/docs/integrations/google">Google Cloud Firewall</a></h4>
    ...
    <div className="box smallbox5 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud Functions</a></h4>
    ...
    <div className="box smallbox6 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud IAM</a></h4>
    ...
    <div className="box smallbox7 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud Load Balancing</a></h4>
    ...
    <div className="box smallbox8 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud SQL</a></h4>
    ...
    <div className="box smallbox9 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud Storage</a></h4>
    ...
    <div className="box smallbox10 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Cloud VPC</a></h4>
    ...
    <div className="box smallbox11 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Compute Engine</a></h4>
    ...
    <div className="box smallbox12 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Kubernetes Engine (GKE)</a></h4>
    ...
    <div className="box smallbox13 card">
      ...
      <h4><a href="/docs/integrations/google/">Google Workspace</a></h4>
