...
* Collect **GCP Metrics** using the [GCP Metric](/docs/send-data/hosted-collectors/google-source/gcp-metrics-source/) source. Make sure that you select **Cloud Logging** from the **Services** dropdown. For Google Logging metrics and dimensions, refer to [Google Logging metrics](https://cloud.google.com/monitoring/api/metrics_gcp#gcp-logging).