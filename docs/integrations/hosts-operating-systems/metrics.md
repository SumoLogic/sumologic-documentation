...
Now that you have configured Host Metrics, install the Sumo Logic App for Host Metrics to take advantage of the preconfigured searches and [dashboards](#Dashboards) to analyze your Host Metrics data.
