...
As part of data collection setup and app installation, you can select the **Linux - OpenTelemetry** app from the **App Catalog** and click on **Install App**. Follow the steps below to configure the collection.
