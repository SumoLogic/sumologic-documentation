...
You can enter these queries into the Search box as a starting baseline, and then customize a query and time range for your system. Be sure to [save your search](/docs/search/Get-Started-with-Search/Search-Basics/Save-a-Search) queries if you plan to run them often.
