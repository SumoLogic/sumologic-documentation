...
* If you plan to integrate Jenkins with this solution, you need to complete additional configuration. The Terraform script does not configure Jenkins. See the following guides to install and configure the Jenkins Sumo Logic plugin:
  ...
  * [Install the Jenkins Plugin] (docs/integrations/app-development/Jenkins/Collect_Logs_and_Metrics_for_Jenkins.md)
  * [Configure Jenkins Plugin] (docs/integrations/app-development/Jenkins/Collect_Logs_and_Metrics_for_Jenkins.md)
  * [Optional - Advanced Configuration] (docs/integrations/app-development/Jenkins/Collect_Logs_and_Metrics_for_Jenkins.md)
  * In [Configure Jenkins Plugin] (docs/integrations/app-development/Jenkins/Collect_Logs_and_Metrics_for_Jenkins.md), a source category is configured which is utilized by the plugin.  Use this source category in the file **sumologic.auto.tfvars file**. The Jenkins source, app, and FERs are installed by Terraform.
...
| Parameter  | Description |
|--|--|
| jenkins_sc | [Jenkins Source Category] (docs/integrations/app-development/Jenkins/Collect_Logs_and_Metrics_for_Jenkins.md). |
