...
| deployment | [Sumo Logic Deployment](/docs/api/authentication-endpoints-security#Sumo-Logic-Endpoints-by-Deployment-and-Firewall-Security) | us1 |
| sumo_api_endpoint | [Sumo Logic API Endpoint.](/docs/api/authentication-endpoints-security#Sumo-Logic-Endpoints-by-Deployment-and-Firewall-Security) Make sure the trailing "/" is present. | https://api.sumologic.com/api/v1/ |
