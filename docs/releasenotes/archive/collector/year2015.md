...
**Bug fix |** Collector installation no longer fails when using the [Setup Wizard](/docs/send-data/setup-wizard) on a machine where Collector software is aready installed.
