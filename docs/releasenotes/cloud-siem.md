...
More information about using the special security indices is in the documentation at [Searching for CSE Data in CIP](docs/cse/../../../cse/records-signals-entities-insights/search-cse-records-in-sumo.md).
...
---
### July 8, 2022 0 Application Update 
