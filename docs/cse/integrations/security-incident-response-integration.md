...
1. **Host**. Enter the Sumo Logic API endpoint for your Sumo Logic deployment. To determine your endpoint, see [Sumo Logic Endpoints by Deployment and Firewall Security](/docs/api/getting-started#sumo-logic-endpoints-by-deployment-and-firewall-security).
