...
| proxy_url | no | A proxy URL to use when communicating with the Sumo Logic backend. For example, `my.proxy.myorg.com:3128` or `username:password@my.proxy.myorg.com:3128`. <br/><br/>Default: No proxy used |
