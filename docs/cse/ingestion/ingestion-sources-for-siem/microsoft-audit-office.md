...
title: Ingest Microsoft 365 Audit Data into SIEM
sidebar_label: Microsoft 365 Audit (Office 365 Audit)
description: Configure collection of Microsoft 365 log messages to be parsed by SIEM's system parser for Microsoft 365. 
---

import useBaseUrl from '@docusaurus/useBaseUrl';

To ingest Microsoft 365 Audit data into SIEM:
1. [Configure a Microsoft Office 365 Audit source](/docs/send-data/hosted-collectors/microsoft-source/ms-office-audit-source/#source-configuration) on a collector. When you configure the source, do the following:
    ...
    1. Add another field named `_parser` with value */Parsers/System/Microsoft/Office 365*. This ensures that the Microsoft Office 365 Audit logs are parsed and normalized into structured records in SIEM.
