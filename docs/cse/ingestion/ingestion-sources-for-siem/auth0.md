---
id: auth0
title: Ingest Auth0 Data into SIEM
sidebar_label: Auth0
description: Configure an HTTP source to ingest Auth0 log messages and send them to SIEM’s Auth0 system parser.
---

import useBaseUrl from '@docusaurus/useBaseUrl';

To ingest Auth0 data into SIEM:
1. [Configure a source for Auth0](/docs/integrations/saml/auth0/#configure-a-source) on a collector. When you configure the source, do the following:
    ...
    1. Click the **+Add** link to add a field whose name is `_parser` with value */Parsers/System/Auth0/Auth0*. This ensures that the Auth0 logs are parsed and normalized into structured records in SIEM.
