...
title: Ingest Microsoft Windows Data into SIEM
sidebar_label: Microsoft Windows
description: Configure collection of Windows Event Log messages and send them to the SIEM Windows Event Log mapper.
---

import useBaseUrl from '@docusaurus/useBaseUrl';
import CollBegin from '../../../reuse/collection-should-begin-note.md';

To ingest Microsoft Windows data into SIEM:
1. [Configure a Local Windows Event Log Source](/docs/send-data/installed-collectors/sources/local-windows-event-log-source/) on a collector. When you configure the source, do the following:
    ...
    1. Add another field named `_parser` with value */Parsers/System/Microsoft/Windows-JSON*. This ensures that the Microsoft Windows logs are parsed and normalized into structured records in SIEM.
