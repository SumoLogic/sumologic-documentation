---
id: aws-cloudtrail
title: Ingest AWS CloudTrail Data into SIEM
sidebar_label: AWS CloudTrail
description: Configure a CloudTrail source to ingest log messages to be parsed by SIEM’s CloudTrail system parser.
---

import useBaseUrl from '@docusaurus/useBaseUrl';

Sumo Logic SIEM supports the default AWS CloudTrail log format which includes all version 2 fields. See [AWS CloudTrail log records documentation](https://docs.aws.amazon.com/vpc/latest/userguide/flow-logs.html#flow-logs-fields) for more details.

To ingest AWS CloudTrail data into SIEM:
...
1. [Configure an AWS CloudTrail source](/docs/send-data/hosted-collectors/amazon-aws/aws-cloudtrail-source/#configure-an-aws-cloudtrail-source) on a collector. When you configure the source, do the following:
    ...
    1. Add another field named `_parser` with value */Parsers/System/AWS/CloudTrail*. This ensures that the CloudTrail logs are parsed and normalized into structured records in SIEM.
