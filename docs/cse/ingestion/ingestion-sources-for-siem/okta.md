---
id: okta
title: Ingest Okta Data into SIEM
sidebar_label: Okta
description: Configure an Okta source to ingest Okta log messages and send them to SIEM’s Okta system parser.
---

import useBaseUrl from '@docusaurus/useBaseUrl';

To ingest Okta data into SIEM:
1. [Configure an Okta source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/okta-source/#source-configuration) on a collector. When you configure the source, do the following:
    ...
    1. Add another field named `_parser` with value */Parsers/System/Okta/Okta*. This ensures that the Okta logs are parsed and normalized into structured records in SIEM.
