...
title: Ingest AWS Network Firewall Data into SIEM
sidebar_label: AWS Network Firewall
description: Configure collection and ingestion of AWS Network Firewall log messages from an S3 bucket to be parsed by SIEM's AWS Network Firewall system parser.
---

import useBaseUrl from '@docusaurus/useBaseUrl';

To ingest AWS Network Firewall data into SIEM:
...
1. [Create an Amazon S3 source](/docs/send-data/hosted-collectors/amazon-aws/aws-s3-source/#create-an-amazons3-source) on a collector. When you configure the source, do the following:
    ...
    1. Add another field named `_parser` with value */Parsers/System/AWS/AWS Network Firewall*. This ensures that the AWS Network Firewall logs are parsed and normalized into structured records in SIEM.
