...
title: Ingest AWS Application Load Balancer Data into SIEM
sidebar_label: AWS Application Load Balancer
description: Configure collection and ingestion of AWS Application Load Balancer (ALB) log messages from an S3 bucket to be parsed by SIEM's AWS ALB system parser.
---

import useBaseUrl from '@docusaurus/useBaseUrl';

To ingest AWS Application Load Balancer data into SIEM:
...
1. [Create an Amazon S3 source](/docs/send-data/hosted-collectors/amazon-aws/aws-s3-source/#create-an-amazons3-source) on a collector. When you configure the source, do the following:
   ...
   1. Add another field named `_parser` with value */Parsers/System/AWS/AWS ALB*. This ensures that the AWS Application Load Balancer logs are parsed and normalized into structured records in SIEM.
