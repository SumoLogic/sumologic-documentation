...
HIPMatch
```
,$receive_time,$serial,$type,$subtype,,$time_generated,$srcuser,$vsys,$machinename,$os,$src,$matchname,$repeatcnt,$matchtype,,,$seqno,$actionflags,$dg_hier_level_1,$dg_hier_level_2,$dg_hier_level_3,$dg_hier_level_4,$vsys_name,$device_name,$vsys_id,$srcipv6,$hostid
```
...
1. Click the gear icon, and select **Log Mappings** under **Incoming Data**. <br/> ![log-mappings-link.png](/img/cse/log-mappings-link.png)
1. On the **Log Mappings** page search for "Palo Alto" and check under **Record Volume**. <br/>  ![palo-alto-firewall-record-volume.png](/img/cse/palo-alto-firewall-record-volume.png)
1. For a more granular look at the incoming records, you can also search the Sumo Logic platform for Palo Alto Firewall security records.  <br/> ![palo-alto-firewall-search.png](/img/cse/palo-alto-firewall-search.png)
