...
1. Click the gear icon at the top of the CSE UI, and select **Sumo Logic** under **Integrations**.<br/><img src={useBaseUrl('img/cse/integrations-sumologic.png')} alt="Sumo Logic integration" width="400"/>
