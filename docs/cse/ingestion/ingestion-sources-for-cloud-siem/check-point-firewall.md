...
1. On the **Log Mappings** page search for "checkpoint" and check under **Record Volume.** <br/><img src={useBaseUrl('img/cse/checkpoint-record-volume.png')} alt="Checkpoint record volume" style={{border: '1px solid gray'}} width="500"/> 
