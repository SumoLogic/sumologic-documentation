...
1. On the **Log Mappings** page search for "CloudTrail" and check under **Record Volume**.<br/><img src={useBaseUrl('img/cse/cloudtrail-record-volume.png')} alt="CloudTrail record volume" style={{border: '1px solid gray'}} idth="600"/>
