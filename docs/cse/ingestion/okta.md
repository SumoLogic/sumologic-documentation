...
1. To create an okta source, please see [Create an Okta Source](https://help.sumologic.com/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/okta-source/#create-an-oktasource).
