...
<img src={useBaseUrl('img/cse/insight-summary-pane.png')} alt="Insight summary" style={{border: '1px solid gray'}} width="500"/>
...
* **Can insight summaries be accessed by the API?**<br/>Yes. The summaries are included in output when you run the [insight APIs](https://api.sumologic.com/docs/sec/#operation/GetInsight) in the [SIEM APIs](/docs/api/siem-enterprise/).
* **Is there an additional cost?**<br/>No. The insight summary is included as part of SIEM at no extra licensing fee.
