...
Parsers are written in a specialized Sumo Parsing Language. The parser code resides in a a parser configuration obect. At runtime, parser code is executed by the Sumo Logic parsing engine.
