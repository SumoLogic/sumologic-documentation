...
slug: /cse/schema
title: SIEM Schema
description: Learn about SIEM Schema v3, schema attributes, and the record processing pipeline.
---

import useBaseUrl from '@docusaurus/useBaseUrl';

This guide has information about SIEM schemas. In this section, we'll introduce the following concepts:
...
<div className="box smallbox card">
  ...
  <p>Learn how SIEM transforms incoming raw messages into records.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
  <a href={useBaseUrl('docs/cse/schema/schema-attributes')}><img src={useBaseUrl('img/icons/operations/schema.png')} alt="Flow diagram icon" width="40"/><h4>SIEM Schema Attributes</h4></a>
  <p>Learn about SIEM schema attributes.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
  ...
  <p>Learn what SIEM schema attributes you can map to records.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
...
<div className="box smallbox card">
  ...
  <p>Set up schema fields with an enforced, SIEM-defined output.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
  ...
  <p>Set up field mappings for messages that you want to be processed by SIEM's normalized threat rules.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
...
<div className="box smallbox card">
  ...
  <p>Parsing is the first step in the SIEM record processing pipeline.</p>
  </div>
</div>
<div className="box smallbox card">
  <div className="container">
...
<div className="box smallbox card">
  ...
  <p>Learn about how SIEM normalizes usernames and hostnames during mapping and parsing.</p>
  </div>
</div>
</div>
