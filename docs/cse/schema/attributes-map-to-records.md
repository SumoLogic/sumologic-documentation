...
description: Learn what SIEM schema attributes you can map to records.
---
...
For the complete list of attributes you can map to records, see [Schema: General Schema Fields](https://github.com/SumoLogic/siem-content-catalog/blob/master/schema/general_fields.md) in the [SIEM Content Catalog](https://github.com/SumoLogic/siem-content-catalog/blob/master/README.md).
