...
<img src={useBaseUrl('img/cse/Configuration.png')} alt="Configuration" style={{border: '1px solid gray'}} width="800"/>
...
<img src={useBaseUrl('img/cse/Example_UI.png')} alt="Example UI" style={{border: '1px solid gray'}} width="600"/>
