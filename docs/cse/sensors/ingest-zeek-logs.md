...
1. In Cloud SIEM, click the gear icon and select **Sumo Logic** under **Integrations**.<br/><img src={useBaseUrl('img/cse/gear-integrations-sumo.png')} alt="Gear integrations" width="150"/>
...
:::caution End-of-Life
This section describes using the Cloud SIEM Network Sensor. The Network Sensor has reached end of life and is no longer supported. Instead, use Zeek. For more information, see [Ingest Zeek Logs](/docs/cse/sensors/ingest-zeek-logs/). 
:::
