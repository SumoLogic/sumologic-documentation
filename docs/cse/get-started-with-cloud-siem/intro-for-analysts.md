...
You're concerned about traffic coming from a particular IP address that is not covered by any of the default rules in Cloud SIEM. Write a match rule that looks for this IP address.
