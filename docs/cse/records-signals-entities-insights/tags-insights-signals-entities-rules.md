...
title: Using Tags with Insights, Signals, and Rules
...
1. [**New UI**](/docs/get-started/sumo-logic-ui). In the main Sumo Logic menu, select **Cloud SIEM > Search Cloud SIEM**, and click the funnel icon. You can also click the **Go To...** menu at the top of the screen and select **Search Cloud SIEM**. <br/>[**Classic UI**](/docs/get-started/sumo-logic-ui-classic). Near the top of the screen, click in the Cloud SIEM search area and then click the funnel icon.  <br/><img src={useBaseUrl('img/cse/funnel-icon.png')} alt="Funnel icon" width="400"/>
