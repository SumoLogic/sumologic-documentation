...
1. In the top menu, click in the Cloud SIEM search area and then click the funnel icon.<br/><img src={useBaseUrl('img/cse/funnel-icon.png')} alt="Funnel icon" width="400"/>
