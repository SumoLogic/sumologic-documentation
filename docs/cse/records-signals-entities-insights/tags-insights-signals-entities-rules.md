...
<br/>[**New UI**](/docs/cse/introduction-to-cloud-siem/#new-ui). In the main Sumo Logic menu select **Cloud SIEM > Insights**. You can also click the **Go To...** menu at the top of the screen and select **Insights**.
...
1. [**Classic UI**](/docs/cse/introduction-to-cloud-siem/#classic-ui). In the top menu click **Content > Custom Insights**.
