...
An insight’s Global Confidence Score (GCS) represents a level of confidence, predicted by Sumo Logic’s Global Intelligence machine learning model, that the insight is actionable. 
...
<img src={useBaseUrl('img/cse/Confidence-Screenshot.png')} alt="Global Confidence Score image example" width="250"/>
