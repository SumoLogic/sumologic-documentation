...
* If you have the latest version of [Cloud SOAR](/docs/cloud-soar/overview) in addition to the Automation Service, you use Cloud SOAR for all your automation. The playbooks can include all the Cloud SOAR features, including containment actions.
:::
