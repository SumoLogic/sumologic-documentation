...
1. You’re prompted to select an operator: **is** or **is not**.  <br/><img src={useBaseUrl('img/cse/operators.png')} alt="Example operators" width="400"/>
