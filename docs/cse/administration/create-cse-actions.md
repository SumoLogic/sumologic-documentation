...
What gets sent to the target system depends on the Action type. For some types, such Slack, Microsoft Teams, and PagerDuty, the notification contains a summary of the Insight with the following information:
