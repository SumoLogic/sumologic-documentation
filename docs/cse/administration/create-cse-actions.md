...
:::caution
Cloud SIEM Actions are deprecated. Instead, use the Automation Service. For more information, see [Migrate from legacy actions and enrichments to the Automation Service](/docs/cse/automation-service/automation-service-automations#migrate-from-legacy-actions-and-enrichments-to-the-automation-service).
:::
