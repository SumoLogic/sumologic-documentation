...
1. This screenshot of the **Workflow** page shows the three Insight statuses that are preconfigured:
    * **New**
    * **In Progress**
    * **Closed**  <br/><img src={useBaseUrl('img/cse/workflow-page.png')} alt="Workflow page" width="600"/>
...
<img src={useBaseUrl('img/cse/status-dropdown.png')} alt="Status dropdown" width="400"/>
