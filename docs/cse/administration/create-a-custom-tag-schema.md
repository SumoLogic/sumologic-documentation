...
1. Click the gear icon at the top of the Cloud SIEM UI and select **Tag Schemas** under **Workflow**.  <br/><img src={useBaseUrl('img/cse/gear-tag-schema.png')} alt="Access tag schemas" width="800"/>
