...
For documentation of the Cloud SIEM audit log definitions, see [Cloud SIEM audit log definitions](/docs/manage/security/audit-indexes/documentation-audit-event-log-definitions/#cloud-siem-audit-log-definitions).
