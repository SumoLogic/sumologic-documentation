...
The Event Analytics Management API allows you to configure event extration rules from HTTP endpoints. For more information, refer to the [Event Extraction Rules](/docs/manage/event-extraction-rules).
