...
You can use the following script to exercise the API. We recommended you to send AccessID/ACCESSKEY pair even if they are sending cookies for the Search Job APIs.
