...
<img src={useBaseUrl('img/apm/services-map-icon.png')} alt="Services Map icon" width="50"/>
...
| ESC | AWS European Sovereign Cloud | eusc-de-east-1 | https://api.esc.sumologic.com/docs/#tag/serviceMap  |
