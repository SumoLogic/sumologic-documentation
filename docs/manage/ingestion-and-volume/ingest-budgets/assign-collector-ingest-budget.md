...
If you do not have the **Manage Ingest Budgets** [role capability] (../../Users-and-Roles/Manage-Roles/05-Role-Capabilities.md "Role Capabilities") but have the **Manage Collectors** capability on its own you can assign a Collector to an Ingest Budget by manually adding the field **\_budget** with the **Field Value** from the desired Ingest Budget into the [Fields] (../../Fields.md "Fields") property. For example, if you have a budget with a Field Value of **Dev_20GB**, you would add: 
