...
* Aggregated Scheduled Views do not incur charges for storage, ingestion, or querying the SV, and will always show 0 bytes storage regardless of the actual data size, though queries used to maintain the SV may still be charged.
