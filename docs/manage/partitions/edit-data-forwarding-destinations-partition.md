...
1. Click the Partition you want to update.<br/><img src={useBaseUrl('/img/partitions-data-tiers/partitions-page.png')} alt="partitions-page" style={{border:'1px solid gray'}} width="800"/>
