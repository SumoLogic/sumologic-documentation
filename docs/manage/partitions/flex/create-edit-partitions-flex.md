...
1. (Optional) **Include this partition in default scope**. By default, this checkbox is selected. Deselect this checkbox if you need to exclude this partition from the [default scope in your search](/docs/manage/partitions/flex/flex-pricing-faq/#how-can-i-optimize-my-query-using-default-scope).
    :::note
