...
* [Jira](webhook-connections-jira.md)
...
snippet support {@import ../../../reuse/alert-variables.md}
...
![test connection button.png](/img/conneciton-integration/test-connection-button.png)
