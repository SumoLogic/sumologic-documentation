...
* **Free** accounts give you access to core Sumo Logic features, with a daily 500 MB data volume limit. Free accounts allow three users, with 4 GB of retention. For information about Free account features, see the "Free Accounts" column in the following table and the Important notes section on [Sumo Logic Free accounts](./01Cloud_Flex_Accounts.md "Cloud Flex").

    :::tip
    Free account holders can [upgrade](04Upgrade_Your_Account.md "Upgrade Your Account") to Professional from within Sumo Logic.
    :::

* **Trial** accounts allow you to try all of Sumo Logic's advanced features to understand how Sumo Logic will fit within your organization before you buy. It includes a daily data volume limit of 1 GB per day, with 20 users and 30 days of data retention. For information about Trial account features, see the "Trial Accounts" column in the table below and [Important notes on Sumo Logic Trial accounts](./01Cloud_Flex_Accounts.md "Cloud Flex").  

    :::note
    Trials are limited to 30 days. If you require an extended trial period, contact [sales@sumologic.com](01Cloud_Flex_Accounts/mailto:sales@sumologic.co.md "mailto:sales@sumologic.com") to inquire about a Proof of Concept (PoC).
    :::

* **Professional** accounts scale to meet your growing needs for user licenses, data retention, and volume options based on subscription. You can [upgrade](04Upgrade_Your_Account.md "Upgrade Your Account") from a Professional to an Enterprise account at any time.
* **Enterprise** accounts, the premier Sumo Logic log management solution, are built to fit your organization's needs for data volume, data retention, and user management requirements. Enterprise accounts include [Ingest Budgets](../Ingestion-and-Volume/Ingest_Budgets.md "Ingest Budgets") and [SAML-based SSO](../Security/SAML/01-Set-Up-SAML-for-Single-Sign-On.md "Set Up SAML for Single Sign-On"). 

    :::note
    [Ingest Budgets](../Ingestion-and-Volume/Ingest_Budgets.md "Ingest Budgets") are only available for Enterprise accounts. Ingest budgets control the capacity of daily log ingestion volume sent to Sumo Logic from Collectors.
    :::
...
| Data Forwarding | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | 
| Data Volume Index | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | 
| Field Extraction | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | 
| Ingest Budgets | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | 
...
| LogReduce  | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | ![check](/img/reuse/check.png) | 
...
:::important
It's important to keep track of your daily usage. For tips on how to monitor and limit the data you're sending to Sumo Logic, see [Manage Ingestion.](../Ingestion-and-Volume/01Log_Ingestion.md "Manage/Ingestion-and-Volume/01Manage-Ingestion")
:::
...
* If you begin to reach the 500 MB daily limit, Sumo Logic sends an email to let you know. You can take action to [reduce the amount of data](../Partitions_and_Data_Tiers/11_Manage_Indexes_with_Variable_Retention.md "Manage Indexes with Variable Retention") you're uploading in order to stay below the limit.
...
* For Sumo Logic Apps, Free accounts are limited to install the [Log Analysis QuickStart app](../../01Start-Here/Library/Apps-in-Sumo-Logic/01-Sumo-Logic-Apps/Log-Analysis-QuickStart-App.md "Log Analysis QuickStart App").
* The limitations of a Free account can't be changed, but you can upgrade to a Professional account at any time.
* For information on throttling and account caps, see [Manage Ingestion](../Ingestion-and-Volume/01Log_Ingestion.md "Manage Ingestion").
...
[Data Tiers](../Partitions_and_Data_Tiers/Data_Tiers.md "Data Tiers") provide economic flexibility by aligning your analytics to the value of your data. By using the Continuous and Frequent tiers, you can appropriately segment your data by use case and analytics needs, thus enabling you to optimize your analytics investments.

:::note
[Data Tiers](../Partitions_and_Data_Tiers/Data_Tiers.md "Data Tiers") must be enabled on your Cloud Flex plan to be able to access this functionality. For more information, contact your Sumo Logic Account Representative.
:::
...
* **Storage.** Shows your daily storage capacity and average daily storage usage. You can adjust capacity use by modifying your [retention periods](../Partitions_and_Data_Tiers/11_Manage_Indexes_with_Variable_Retention.md "Manage Indexes with Variable Retention").
...
:::note
If you are your Sumo Logic account owner, your Account page also displays a **Manage Organization** section. For information on these options, see [Manage Organization](12Manage_Organizational_Settings.md "Manage Organization").
:::
