...
1. In the **Content** bar, select the content to be pushed:
   ...
   * **Source Template**. For more information about Source Templates, refer to [Source Template](/docs/send-data/opentelemetry-collector/remote-management/source-templates/).
