...
* If you choose not to use this SSO feature, click [Disable SSO](#disable-sso) on the child organizations. Then users log in with username and password, or you can [set up SAML for single sign-on](/docs/manage/security/saml/set-up-saml/) yourself on the child organizations.