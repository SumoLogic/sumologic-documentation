...
| Administration - Account | [Account overview](/docs/manage/manage-subscription/cloud-flex-credits-accounts/#account-page) |![check](/img/reuse/check.png)|![check](/img/reuse/check.png)| 
...
| Collection - Cloud APIs | [Office 365 Audit](/docs/send-data/hosted-collectors/ms-office-audit-source/) |![check](/img/reuse/check.png)|![check](/img/reuse/check.png)| 
