...
You can forward log data from a [Partition] (../Partitions_and_Data_Tiers/01-About-Partitions.md "About Partitions") or [Scheduled View] (../Scheduled-Views.md "Scheduled Views") to an S3 bucket. Only new data is forwarded from a Partition once it is set to forward data. 
