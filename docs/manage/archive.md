...
1. Configure the following:
   ...
   * **Access Method**. Select **Role-based access** or **Key access** based on the AWS authentication you are providing. Role-based access is preferred. This was completed in step 1, [Grant Sumo Logic access to an AWS Product](../send-data/sources/hosted-collectors/amazon-aws/grant-access-aws-product.md).
