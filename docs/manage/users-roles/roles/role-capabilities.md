...
| Settings General | Configure | Configure [settings](/docs/cloud-soar/cloud-soar-settings/). |
| User Management | Groups | Manage [groups](/docs/cloud-soar/cloud-soar-settings/#groups). |
| Notification | Configure | Configure [notifications](/docs/cloud-soar/cloud-soar-settings/#notifications). |
| Customization | Logo | Customize the logo. |
| Customization | Fields | Customize [fields](/docs/cloud-soar/cloud-soar-settings/#custom-fields). |
