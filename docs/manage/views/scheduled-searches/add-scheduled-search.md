---
id: add-scheduled-search
title: Add a Scheduled Search
description: Learn how to add a Scheduled Search.
---
import useBaseUrl from '@docusaurus/useBaseUrl';

This section describes how to create a Scheduled Search at the time you save a search and add it to Views.
...
When creating a Scheduled Search, you can configure **Alert Type** as `Save to Index`:

* [Save to Index](/docs/alerts/scheduled-searches/save-to-index). Save search results to an index for future retrieval. This way, your data can be searched at a later time using `_index=index_name` with increased search performance.
