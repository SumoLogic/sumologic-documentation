...
See [About Partitions](/docs/manage/partitions-and-data-tiers) for limitations.
...
1. Click **Edit **to open the pane for editing.<br/> ![edit-partition-pane.png](/img/partitions-and-data-tiers/edit-partition-pane.png)
