...
A user designated as Account Owner cannot be deleted. To transfer ownership, the account owner must do this on the **Account** page. For more information, see [Cloud Flex Accounts](../../manage-subscription/cloud-flex-accounts.md) or [Cloud Flex Credits Accounts](../../manage-subscription/cloud-flex-credits-accounts.md), depending on your Sumo Logic packaging.
