...
This index is improved and different from the [Audit Index](Audit-Index.md "Enable and Manage Auditing"), and there is some overlap of audited events. The Audit Index provides event logs in plain text and audits when account limits are reached and operation failures, like throttling and scheduled search events.
...
| -- | -- |
| [Access Keys](Access-Keys.md "Access Keys") | `accessKeys` |
| [Collection](../Collection.md "Collection") | `collection` |
| [Content Sharing](../Content_Sharing.md "Content Sharing") | `content` |
| [Data Forwarding](../Data-Forwarding.md "Data Forwarding") | `dataForwarding` |
| [Field Extractions](../Field-Extractions.md "Field Extractions") | `fieldExtractionRules` |
| [Fields](../Fields.md "Fields") | `fieldManagement` |
| [Ingest Budgets](../Ingestion-and-Volume/Ingest_Budgets.md "Ingest Budgets") | `ingestBudgets` |
| [Installation Tokens](Installation_Tokens.md "Installation Tokens") | `token` |
...
| [Password Policy](Set-the-Password-Policy.md "Set the Password Policy") | `passwordPolicy` |
| [Roles](../Users-and-Roles/Manage-Roles.md "Manage Roles") | `roles` |
| [SAML](SAML.md "SAML") | `saml` |
| [Scheduled Views](../Scheduled-Views.md "Scheduled Views") | `scheduledView` |
| Security Policies: [Share Dashboards Outside of the Organization](../../Visualizations-and-Alerts/Dashboards/Share_Dashboards/Share_a_Dashboard_Outside_Your_Org.md "Share a Dashboard Outside Your Org"), [Data Access Level for Shared Dashboards](Data_Access_Level_for_Shared_Dashboards.md "Data Access Level for Shared Dashboards"), [Per User Concurrent Sessions Limit](Set_a_Limit_for_User_Concurrent_Sessions.md "Set a Limit for User Concurrent Sessions"), and [User Session Timeout](Set_a_Maximum_Web_Session_Timeout.md "Set a Maximum Web Session Timeout") | `orgSettings` |
| Security Policy: [Support Account Access](Enable-a-Support-Account.md "Enable a Support Account") | `supportAccount` |
| [Service Allowlist](Create-an-Allowlist-for-IP-or-CIDR-Addresses.md "Create a Whitelist for IP or CIDR Addresses") | `serviceAllowlist` |
...
| [2-Step Verification](About-2-Step-Verification.md "About 2-Step Verification") | `multiFactorAuthentication` |

## Metadata assignment

[Metadata](../../05Search/Get-Started-with-Search/Search-Basics/Built-in-Metadata.md "Search Metadata")
fields are assigned to audit event logs as follows:

| Metadata Field | Assignment Description |
| -- | -- |
| \_sourceCategory   | Value of the [common parameter](./Audit_Event_Index.md "Audit Event Index"), `subsystem`. |
| \_sourceName | Value of the [common parameter](./Audit_Event_Index.md "Audit Event Index"), `eventName`. |
...
| eventTime | The event timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601 "Audit Event Index") format. | String |
