...
## Enable support account access for your organization

To enable support account access for your organization to Sumo Logic support users:
...
1. When Sumo Logic sends an email to verify access by support users, click **Manage Access** in the email.<br/><img src={useBaseUrl('img/security/enable-support-account-access-email.png')} alt="Support Account Access email" style={{border: '1px solid gray'}} width="300" />
1. You are redirected to the Sumo Logic **Policies** page, and the new access request appears in a table under **Support Account Access**. Click **Approve Access** to approve the request. (If you didn't request access, click **Deny Access**.)<br/><img src={useBaseUrl('img/security/enable-support-account-access-user-request.png')} alt="Support Account Access request" style={{border: '1px solid gray'}} width="800" />
