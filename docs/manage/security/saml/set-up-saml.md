...
1. Select an existing configuration, or click the plus (**+ Add Configuration**) button to create a new configuration. <br/><img src={useBaseUrl('img/security/saml-config-list.png')} alt="Plus button on the Configuration List page" style={{border: '1px solid gray'}} width="600" />
