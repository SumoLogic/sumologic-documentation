...
1. Select **Or Choose File** from the Import Metadata XML prompt and select the XML file you downloaded in substep 13 of [Configure Sumo Logic as an Enterprise App in Azure AD](#configure-sumo-logic-as-an-enterprise-app-in-azure-ad).
...
1. Verify the **Issuer** and **X.509 Certificate** fields have been populated by the import. If these fields are not populated:
    1. **Issuer**. Enter the **Azure AD Identifier** that you noted in the substep 14 of [Configure Sumo Logic as an Enterprise App in Azure AD](#configure-sumo-logic-as-an-enterprise-app-in-azure-ad).
    2. **X.509 Certificate**. Use a text editor to open the certificate file you downloaded in substep 12 of [Configure Sumo Logic as an Enterprise App in Azure AD](#configure-sumo-logic-as-an-enterprise-app-in-azure-ad). Copy and paste the contents of the file into the field.   
