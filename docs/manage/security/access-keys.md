...
`The request origin is not allowlisted to use this access key`
...
1. The window displays the generated Access ID and Access Key. Copy both before clicking **Close**. After you press **Close**, you will not be able to recover the Access ID and Access Key.

    ![generated-access-key.png](/img/security/generated-access-key.png)
...
![my-access-keys1.png](/img/security/my-access-keys1.png)
...
![access-key-three-dot.png](/img/security/access-key-three-dot.png)
