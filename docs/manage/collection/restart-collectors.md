...
* The Collector is not running or [offline] (../../03Send-Data/Installed-Collectors/01About-Installed-Collectors.md).
...
The [Audit Event Index](../Security/Audit_Event_Index.md "Audit Event Index") keeps
