...
1. First-time contributors will be prompted in a PR comment to sign our Contributor License Agreement. We allow individual contributions and contributions made on behalf of companies.<br/> <img src={useBaseUrl('img/contributing/clabot.png')} alt="CLA bot" style={{border: '1px solid gray'}} width="600" />
