...
Recovery will have either `ResolvedCritical`, `ResolvedWarning`, or `ResolvedMissingData`. | <img src={useBaseUrl('img/reuse/check.png')} alt="green check circle.png" width="20"/> |  |
