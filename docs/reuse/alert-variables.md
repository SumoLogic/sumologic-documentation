...
:::tip
We recommend you use the new [common variables](../manage/connections-and-integrations/webhook-connections/set-up-webhook-connections.md) instead of these legacy variables. In the future, legacy variables will be deprecated.
:::
