...
:::tip
We recommend you use the new [common variables](/docs/manage/connections-and-integrations/webhook-connections/set-up-webhook-connections) instead of these legacy variables. In the future, legacy variables will be deprecated.
:::
