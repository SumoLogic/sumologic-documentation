...
| <img src={useBaseUrl('img/content-sharing/classic-icon-more-actions-kebab-three-dot.png')} alt="classic-icon-more-actions-kebab-three-dot.png" width="15%" /> | More Actions / Three-Dot Kebab  | Click to reveal a menu with additional options. |
