...
| ![icon-personal-folder.png](/img/content-sharing/icon-personal-folder.png) | Personal | Content you manage. |
...
| <img src="/img/content-sharing/icon-more-actions-kebab-three-dot.png" alt="more-actions-kebab-three-dot.png" width="20%" /> | More Actions  | Click to reveal a menu with additional options. |
