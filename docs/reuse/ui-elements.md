...
| :-- | :-- | :-- |
| <img src={useBaseUrl('img/content-sharing/icon-recent.png')} alt="Recent icon" width="20%" /> | Recent | Access content you’ve recently accessed and recently shared with you. |
| <img src={useBaseUrl('img/content-sharing/icon-favorites.png')} alt="Favorites icon" width="20%" /> | Favorites | Content you’ve marked as favorite. |
| <img src={useBaseUrl('img/content-sharing/icon-library.png')} alt="Library icon" width="20%" /> | Library | List of all accessible content, including your creations and the content shared with you. |
| <img src={useBaseUrl('img/content-sharing/classic-icon-more-actions-kebab-three-dot.png')} alt="More actions kebab" width="20%" /> | More Actions / Three-Dot Kebab | Click to reveal a menu with additional options. |
...
| <img src={useBaseUrl('img/content-sharing/classic-nav-menu.png')} alt="Nav menu" width="70%" /> | Navigation Menu  | Main Sumo Logic menu containing your collectors, sources, library, help, and more. |
