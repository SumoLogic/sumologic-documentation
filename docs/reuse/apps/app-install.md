...
1. On the next configuration page, under **Select Data Source for your App**, complete the following fields:
   * **Data Source**. Select one of the following options:
      * Click **Source Category** and select a source category from the list
      * Click **Enter a Custom Data Filter** and [enter a custom source category](/docs/get-started/apps-integrations#custom-data-filters) beginning with an underscore. For example, `_sourceCategory=MyCategory`.
...
You'll then see a dialog confirming that the app was installed successfully.<br/><img src="/img/get-started/library/app-success.png" alt="app-success.png" width="80%" />
