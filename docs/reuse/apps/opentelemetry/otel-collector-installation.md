...
This will generate a command that you can execute in the machine environment you need to monitor. Once executed, it will install the Sumo Logic OpenTelemetry Collector.<br/><img src={useBaseUrl('img/send-data/opentelemetry-collector/remotely-managed.png')} alt="Remotely Managed icon" />
