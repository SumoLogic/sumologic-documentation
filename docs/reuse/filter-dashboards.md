...
- Click the funnel icon in the dashboard top menu bar to [filter dashboard with Template Variables](/docs/dashboards/filter-template-variables/).<br/> <img src="/img/dashboards-new/filter-dashboards.png" alt="filter-dashboards" style={{border: '1px solid black'}} width="200" />
