...
- Click the funnel icon in the dashboard top menu bar to [filter the dashboard with template variables](/docs/dashboards/filter-template-variables/).<br/> <img src={useBaseUrl('img/dashboards/filter-dashboards.png')} alt="filter-dashboards" style={{border: '1px solid gray'}} width="200" />
