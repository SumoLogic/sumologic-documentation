...
1. Scroll to the bottom and select **Create a new branch for this commit and start a pull request**.
1. In the field underneath, enter a name for your branch and click **Propose Change**.
...
1. In your new branch, edit the doc markdown file. See our [Style Guide](/docs/contributing/style-guide) to learn how to style content, add code snippets, import multimedia, and more. Doc body text content is written in GitHub-flavored markdown, with some customizations.
