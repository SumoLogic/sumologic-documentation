...
<div className="box smallbox card">
  ...
  <a href={useBaseUrl('docs/platform-services/automation-service')}><img src={useBaseUrl('img/icons/security/siem.png')} alt="SIEM icon" width="40"/><h4>Automation Service</h4></a>
