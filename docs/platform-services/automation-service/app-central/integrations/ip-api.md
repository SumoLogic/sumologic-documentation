...
To configure IP-API, log into [IP-API](https://members.ip-api.com/) with your e-mail and password. 

In the main page, click on the section Manage API Keys. 

![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-1.png)

Copy the API key and save it (temporarily) in a text editor.

![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-2.png)

## IP-API in Automation Service and Cloud SOAR

To configure the integration, log into the application, expand the configuration menu in the top right corner by hovering over the gear icon and click Automation.

![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-3.png)

In the Automation section, on the left menu, click Integrations.

![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-4.png)
...
![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-7.png)

Click Test Saved Settings.

![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-8.png)

You should receive a successful notification in the bottom right corner.

![](/img/platform-services/automation-service/app-central/integrations/ip-api/ip-api-9.png)
