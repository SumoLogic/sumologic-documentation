...
To configure Vectra, sign in to [Vectra](https://apitest.vectracloudlab.com) with username and password. 

In the main page, click on the section My Profile.

![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-1.png)
...
![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-2.png)

In the Automation section, on the left menu, click Integrations.

![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-3.png)
...
![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-5.png)

To make sure the resource is working, hover over the resource and then click the pencil icon that appears on the right.

![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-6.png)

Click Test Saved Settings.

![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-7.png)

You should receive a successful notification in the bottom right corner.

![](/img/platform-services/automation-service/app-central/integrations/vectra/vectra-8.png)
