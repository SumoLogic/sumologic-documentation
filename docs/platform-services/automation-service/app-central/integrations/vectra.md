...
:::info
Sumo Logic also supports the [Vectra source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/vectra-source/) and the [Vectra app](/docs/integrations/saas-cloud/vectra/) to collect and visualize Vectra data.
:::
