...
* **Scaled Decimal to Percentage** (*Custom*) - Converts a scaled decimal values between 0 and 1 into a percentage. [Scaled Decimal to Percentage](#scaled-decimal-to-percentage).
