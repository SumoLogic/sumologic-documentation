...
1. In the main Sumo Logic menu, select your username and then **Preferences**. <br/><img src={useBaseUrl('/img/platform-services/automation-service/app-central/integrations/sumo-logic-notifications-by-gmail/sumo-logic-notifications-by-gmail-1.png')} style={{border:'1px solid gray'}} alt="sumo-logic-notifications" width="200" height="400"/>
...
12. In Cloud SOAR, navigate to **Settings > Integrations > Gmail**, add a new Resource and provide the following inputs:
...
3. The integration details will appear. Click on the **"+"** button to add new Resource.<br/><img src={useBaseUrl('/img/platform-services/automation-service/app-central/integrations/sumo-logic-notifications-by-gmail/sumo-logic-notifications-by-gmail-6.png')} style={{border:'1px solid gray'}} alt="sumo-logic-notifications" width="600"/>
4. Populate all the required fields (\*) and then click Save. 
    * <br/><img src={useBaseUrl('/img/platform-services/automation-service/app-central/integrations/sumo-logic-notifications-by-gmail/sumo-logic-notifications-by-gmail-7.png')} style={{border:'1px solid gray'}} alt="sumo-logic-notifications" width="400"/>
