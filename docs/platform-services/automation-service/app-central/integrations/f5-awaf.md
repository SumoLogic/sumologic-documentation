...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/logos/f5-awaf.png')} alt="F5 AWAF icon" width="60"/>
...
| v1.0 | December 15, 2021 | Initial release of the F5 AWAF integration. |
