...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/logos/threat-crowd.png')} alt="Threat Crowd icon" width="100"/>
...
| v1.2 | June 30, 2023 | Updated the integration with environmental variables. |
| | September 17, 2019 | Initial release of the Threat Crowd integration. |
