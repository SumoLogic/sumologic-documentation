...
:::info
Sumo Logic also supports the [Druva source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/druva-source/) and the [Druva app](/docs/integrations/saas-cloud/druva/) to collect and visualize Druva data.
:::
