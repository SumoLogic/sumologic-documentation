...
1. To configure the integration, log into the application, expand the configuration menu in the top right corner by hovering over the gear icon and click **Automation**. <br/><img src={useBaseUrl('/img/platform-services/automation-service/app-central/integrations/abuse.ch-sslbl-feed/abuse.ch-sslbl-feed-1.png')} style={{border:'1px solid gray'}} alt="abuse.ch-sslbl-feed-1" width="400"/>
1. In the Automation section, on the left menu, click **Integrations**. <br/><img src={useBaseUrl('/img/platform-services/automation-service/app-central/integrations/abuse.ch-sslbl-feed/abuse.ch-sslbl-feed-2.png')} style={{border:'1px solid gray'}} alt="abuse.ch-sslbl-feed-2" width="400"/>
