...
![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-1.png)

From the preferences screen, in the section My Access Keys, click on Add Access Key.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-2.png)

Populate the name and click Create Key.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-3.png)
...
![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-4.png)

## Sumo Logic in Automation Service and Cloud SOAR

To configure the integration, log into the application, expand the configuration menu in the top right corner by hovering over the gear icon and click Automation.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-5.png)

In the Automation section, on the left menu, click Integrations.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-6.png)

After the list of the integrations appears, search/look for the integration and click on the row.

The integration details will appear. Click on the "+" button to add new Resource.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-7.png)
...
![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-8.png)

To make sure the resource is working, hover over the resource and then click the pencil icon that appears on the right.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-9.png)

Click Test Saved Settings.

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-10.png)

You should receive a successful notification in the bottom right corner

![](/img/platform-services/automation-service/app-central/integrations/sumo-logic/sumo-logic-11.png)
