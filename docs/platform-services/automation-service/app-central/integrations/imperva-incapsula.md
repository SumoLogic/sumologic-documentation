...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/logos/imperva-incapsula.png')} alt="Imperva Incapsula icon" width="100"/>
...
:::info
Sumo Logic also supports the [Imperva Incapsula app](/docs/integrations/security-threat-detection/imperva-incapsula/) to visualize Imperva Incapsula data.
:::
