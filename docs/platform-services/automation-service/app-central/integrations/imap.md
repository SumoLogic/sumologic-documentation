...
| | May 5, 2022 | Added new filter options for the **Incoming Mail Daemon** action. |
| | March 8, 2022 | Updated the description and guide. |
| | February 8, 2021 | Updated actions. |
| | May 7, 2019 | Initial release of the IMAP integration. |
