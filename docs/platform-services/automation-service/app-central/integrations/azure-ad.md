...
Log into Azure portal with the user that has administrator privileges.

Navigate to **Azure Active Directory** > **App registrations** > **New registration**

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-1.png)

In the registration form, choose a name for your application and then click Register.

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-2.png)

Write down the Application ID and Directory ID, you will need them later for the integration configuration.

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-3.png)

Configure Azure AD Application permissions: on the left choose API permissions.

Then click the Add a permission button.

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-4.png)
...
![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-5.png)
...
You should have the permissions as in the screenshot below:

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-6.png)
...
![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-7.png)

Once Admin Consent is granted, API permissions configuration have been completed.

Then we have to add a Client secret that will be used for the authentication, along with Client ID and Directory ID. 

To add Client secret, go to Certificates and secrets, and click New client secret.

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-8.png)
...
![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-9.png)

Once you do these steps you will need to find the Tenant ID in order to use it on your resources file.

![](/img/platform-services/automation-service/app-central/integrations/azure-ad/azure-ad-10.png)
