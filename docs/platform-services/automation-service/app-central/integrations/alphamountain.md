...
| v1.0 | September 15, 2022 | <ul><li>Changed the integration name in alphaMountain.</li><li>Updated the integration guide.</li><li>Renamed the **Get Likely Impersonations** action to **Get Possible Impersonations**.</li><li>Updated the table view for **Get Categories** and **Get Threat Score**.</li></ul> |
| v1.0 | June 21, 2022 | Initial release of the alphaMountain integration. |