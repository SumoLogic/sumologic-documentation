...
:::info
Sumo Logic also supports the [Automox source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/automox-source/) and the [Automox app](/docs/integrations/saas-cloud/automox/) to collect and visualize Automox data.
:::
