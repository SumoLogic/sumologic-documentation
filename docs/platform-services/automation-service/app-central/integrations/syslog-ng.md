...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/logos/syslog-ng.png')} alt="Syslog NG icon" width="70"/>
...
| v1.0 | June 17, 2021 | Initial release of the Syslog-NG integration. |
