...
* **Check Submission Status** (*Enrichment*) - Check the status of a submission and return the current state. This scheduled action polls at regular intervals until the analysis reaches a success or partial success state.
