...
:::info
Sumo Logic also supports the [Mandiant Threat Intel source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/mandiant-threat-intel-source/) to collect Mandiant data.
:::
