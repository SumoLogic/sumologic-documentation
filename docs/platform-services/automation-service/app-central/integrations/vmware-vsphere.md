...
1. **Read-Only**: Allows reading details of virtual machines in the vSphere inventory. 
2. For further details on how to create the role, please refer to the following video. [VMWare vSphere Role Creation](https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.security.doc/GUID-5372F580-5C23-4E9C-8A4E-EF1B4DD9033E.html)
3. For the **HOST**, use the _IP_ or _Domain_ of the vSphere node.
4. The port should be set to 443.
