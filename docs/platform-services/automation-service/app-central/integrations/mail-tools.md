...
| v1.2 | January 17, 2023 | <ul><li>Added the **Email Header Regex** action.</li><li>Refactored the integration.</li></ul> |
| v1.1 | February 3, 2022 | Initial release of the Mail Tools integration. |