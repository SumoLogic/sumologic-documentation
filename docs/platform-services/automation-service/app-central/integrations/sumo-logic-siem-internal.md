---
title: Sumo Logic SIEM Internal
description: ''
---
...
This [automation integration](/docs/platform-services/automation-service/app-central/integrations/) utilizes SIEM entities to correlate signals and insights through Sumo Logic system calls. Because this integration operates internally with Sumo Logic, no additional authentication is needed. (The [Sumo Logic SIEM](/docs/platform-services/automation-service/app-central/integrations/sumo-logic-siem/) automation integration requires additional authentication.) 
...
## Configure Sumo Logic SIEM Internal in Automation Service and Cloud SOAR

No configuration is needed. Sumo Logic SIEM Internal executes without additional authentication.
...
* April 5, 2024 (v1.15)
    + The integration formerly known as "CSE Tools" has been renamed to "Sumo Logic SIEM Internal"
+ July 3, 2025 (v1.16)
