...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/logos/mcafee-mvision.png')} alt="McAfee MVISION icon" width="100"/>
...
| v1.0 | March 25, 2021 | Initial release of the McAfee MVISION integration. |
