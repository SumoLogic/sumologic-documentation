...
* January 21, 2025 (v1.12)
    * Updated actions: Send Message, Ask Question, Ask For User Email (Added a fix to support Slack channel and user mentions (e.g., @channel, <!channel>) ensuring proper formatting in messages.)