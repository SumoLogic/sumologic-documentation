...
This [automation integration](/docs/platform-services/automation-service/app-central/integrations/) utilizes SIEM entities to correlate signals and insights. This integration requires authentication. (Because the [Sumo Logic SIEM Internal](/docs/platform-services/automation-service/app-central/integrations/sumo-logic-siem-internal/) integration operates internally with Sumo Logic, no additional authentication is needed.)

For information about SIEM, see [Get Started with SIEM](/docs/cse/get-started-with-siem/).
...
## Configure Sumo Logic SIEM in Automation Service and Cloud SOAR
...
* <IntegrationLabel/>
* <SumoLogicAPIURL/>
* **Sumo Logic SIEM URL**. URL to the SIEM instance (for example, `https://service.sumologic.com/sec`).
* <AccessID/>
* <AccessKey/>
* <IntegrationTimeout/>
...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/integrations/misc/sumo-logic-siem-configuration.png')} style={{border:'1px solid gray'}} alt="Sumo Logic SIEM configuration" width="400"/>
...
* April 5, 2024 (v1.12)
    + The integration formerly known as "Sumo Logic CSE" has been renamed to "Sumo Logic SIEM"
...
* April 8, 2024 (v1.13)
  * Update the resource field name from "Sumo Logic CSE URL" to "Sumo Logic SIEM URL"
* July 3, 2024 (v1.14)
