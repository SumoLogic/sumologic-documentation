...
| v1.1 | October 18, 2023 | Updated the **Assess Alert Status** action so the Scheduled input is now set dynamically. |
| v1.0 | September 22, 2023 | Initial release of the Sumo Logic Notifications integration. |
