...
:::info
Sumo Logic also supports the [Proofpoint TAP source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/proofpoint-tap-source/) and the [Proofpoint TAP app](/docs/integrations/saas-cloud/proofpoint-tap/) to collect and visualize Proofpoint TAP data.
:::
