...
<img src={useBaseUrl('/img/platform-services/automation-service/app-central/logos/telegram-v2.png')} alt="Telegram icon" width="100"/>
...
| | February 12, 2021 | Initial release of the Telegram V2 integration. |
