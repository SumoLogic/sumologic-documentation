...
:::info
Sumo Logic also supports the [ZeroFox Threat Intel source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/zerofox-intel-source/) to collect ZeroFox data.
:::
