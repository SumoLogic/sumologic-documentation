...
* **A collector**. See [STIX/TAXII 2 Client Source](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/). <!-- When article is published, link to stix-taxii-2-client-source -->
