...
The following attributes are required:
       ...
       * **threatType** (string). Type of indicator (as [defined by indicator_types in STIX 2.1](https://docs.oasis-open.org/cti/stix/v2.1/os/stix-v2.1-os.html#_cvhfwe3t9vuo)). For example, `malicious-activity`. (This attribute can result in a special label appearing next to entities in the Cloud SIEM UI. See [How do I view threat indicator labels in the Cloud SIEM UI?](/docs/security/threat-intelligence/threat-indicators-in-cloud-siem/#how-do-i-view-threat-indicator-labels-in-the-cloud-siem-ui).) <br/>Following are valid values:
