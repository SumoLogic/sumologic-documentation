...
<div className="box smallbox card">
  ...
  <a href={useBaseUrl('docs/security/additional-security-features/introduction')}><img src={useBaseUrl('img/icons/security/security.png')} alt="Shield icon" width="40"/><h4>Introduction to Additional Security Features</h4></a>
