...
Sumo Logic leverages OpenTelemetry standards for trace collection. To gather the spans generated by tracing clients, see [Instrument your application with OpenTelemetry](01Instrument_your_application_with_OpenTelemetry.md "Instrument your application with OpenTelemetry"), the OpenTelemetry Collector instance needs to be run. It receives and buffers data, optionally attaches metadata tags, and pushes them to a Sumo Logic Hosted Collector endpoint, residing in the cloud.
...
:::tip
[What if I don't want to send all the tracing data to Sumo Logic?](../03Advanced_Configuration/What_if_I_don't_want_to_send_all_the_tracing_data_to_Sumo_Logic%3F.md)
:::
 ...
 * ENDPOINT_URL needs to be replaced with the value retrieved in [Step 1](#step-1---generating-tracing-endpoint-url),
    point 5.
...
During [instrumentation of your application](01Instrument_your_application_with_OpenTelemetry.md "Instrument your application with OpenTelemetry"), typically you need to configure collector endpoint and protocol.
