...
1. Select **HTTP Traces**.<br/><img src={useBaseUrl('img/traces/http-traces.png')} alt="HTTP Traces source icon" width="100"/>
1. Enter a **Name** for the Source. A description is optional. <br/><img src={useBaseUrl('img/traces/traces-source-no-fields.png')} alt="HTTP Traces source modal with Name, Description, Source Host, Source Category fields" width="450"/>
