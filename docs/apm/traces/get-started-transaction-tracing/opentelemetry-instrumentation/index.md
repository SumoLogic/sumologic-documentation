...
:::tip
Looking for our OTEL collector? The [Sumo Logic Distribution for OpenTelemetry Collector) provides a single unified agent to send Logs, Metrics, Traces, and metadata to Sumo Logic for observability.
:::
