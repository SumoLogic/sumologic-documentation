...
<div className="box smallbox card">
  <div className="container">
  <a href={useBaseUrl('docs/apm/traces/services-list-map')}><img src={useBaseUrl('img/apm/traces/servicemap.png')} alt="icon" width="33"/><h4>Services List and Services Map</h4></a>
...
<div className="box smallbox card">
  <div className="container">
  <a href={useBaseUrl('docs/apm/traces/spans')}><img src={useBaseUrl('img/icons/operations/distributed-operations.png')} alt="icon" width="30"/><h4>Span Analytics and Queries</h4></a>
