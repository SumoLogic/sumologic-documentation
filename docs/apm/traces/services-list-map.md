...
<!--Kanso [**Classic UI**](/docs/get-started/sumo-logic-ui-classic). Kanso--> To access Services, click the **+ New** button at the top of the screen and select **Services**. 
<!--Kanso 
...
1. Open an existing Dashboard or create a new Dashboard. <br/><!--Kanso [**Classic UI**](/docs/get-started/sumo-logic-ui-classic). Kanso-->  Click the **+ New** button at the top of the screen and select **Dashboard**. <!--Kanso <br/>[**New UI**](/docs/get-started/sumo-logic-ui). In the main Sumo Logic menu, select **Dashboards > New Dashboard**. You can also click the **Go To...** menu at the top of the screen and select **New Dashboard**.  Kanso-->
