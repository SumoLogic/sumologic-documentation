...
### Mute  
When a monitor is in a mute state, it continues to process your data stream as expected where Incidents are still generated. However, notifications are snoozed based on your mute condition. See also: [*Muting Schedules*](/docs/alerts/monitors/alert-response#muting-schedules).
