...
### Mute  
When a monitor is in a mute state, it continues to process your data stream as expected where alerts are still generated. However, notifications are suppressed based on your mute condition. See also: [*Muting Schedules*](/docs/alerts/monitors/alert-response#muting-schedules).
