...
* You need the **Manage** or **View Monitors** [role capability](/docs/manage/users-roles/roles/role-capabilities.md) to manage or view monitors, respectively. In addition, you can control permissions at a monitor or folder level. You will need Fine Grain permission feature enabled on your account. More information [here](/docs/alerts/monitors/edit-settings/#monitors-folder-permissions).
