...
<img src={useBaseUrl('img/alerts/monitors/alert_grouping.png')} alt="Alert grouping diagram" />
...
* **Group Condition** service <br/><img src={useBaseUrl('img/alerts/monitors/usecase1.png')} alt="Trigger conditions in the monitor dialog" style={{border: '1px solid gray'}} width="800" />
...
* **Recovery Evaluation Logic**.
    ...
    * Red boxes show that triggered the alert, and green boxes show what resolved the alerts.<br/><img src={useBaseUrl('img/alerts/monitors/usecase1x.png')} alt="Table showing example alert resolution percentages" />
...
* **Query**. `metric=CPU_sys`.
* **Group Condition**. service, env <br/><img src={useBaseUrl('img/alerts/monitors/usecase2.png')} alt="Trigger conditions for multiple alert group fields" style={{border: '1px solid gray'}} width="800" />
...
* **Recovery Evaluation Logic**.
    ...
    * Red boxes shows that triggered the alert, and green boxes shows what resolved the alerts.<br/><img src={useBaseUrl('img/alerts/monitors/usecase2x.png')} alt="Table showing example alert resolution percentages for multiple alert group fields" />
...
* **Query**. `error`
* **Group Condition**. service, env<br/><img src={useBaseUrl('img/alerts/monitors/usecase3.png')} alt="Trigger conditions settings for a logs monitor with multiple alert group fields" style={{border: '1px solid gray'}} width="800" />
...
* **Recovery Evaluation Logic**.
    ...
    * Chart below shows how the alert and recovery notification would have fired for some hypothetical services under various times (t0–t3).
    * Red boxes show what triggered the alert, and green boxes show what resolved the alerts.<br/><img src={useBaseUrl('img/alerts/monitors/usecase3x.png')} alt="Table showing example alert resoutions for a monitor with multiple alert group fields" />
...
* **Group Condition**. service <br/><img src={useBaseUrl('img/alerts/monitors/usecase4.png')} alt="Trigger conditions settings for a logs monitor on a field with alert group" style={{border: '1px solid gray'}} width="800" />
...
* **Recovery Evaluation Logic**.
    ...
    * Chart below shows how the alert and recovery notification would have fired for some hypothetical services under various times (t0–t3)
    * Red boxes show what triggered the alert, and green boxes show what resolved the alerts.<br/><img src={useBaseUrl('img/alerts/monitors/usecase4x.png')} alt="Table showing example alert resolution percentages for monitoring a field with alert group" />
...
* **Query**. `metric=CPU_sys`
* **Group Condition**. service <br/><img src={useBaseUrl('img/alerts/monitors/usecase5.png')} alt="Trigger conditions for a data metrics monitor with alert group" style={{border: '1px solid gray'}} width="800" />
...
* **Query**.  
   ...
   ```
* **Group Condition**. `collector` <br/><img src={useBaseUrl('img/alerts/monitors/Suggested-Monitors.png')} alt="Settings for a collector group condition" style={{border: '1px solid gray'}} width="800" />
