...
1. Click the **View in Metrics Explorer** button. The Metrics Explorer page will display with the same threshold values applied to the panel and graph.<br/><img src={useBaseUrl('img/monitors/view-in-explorer-icon.png')} alt="view-in-explorer-icon" width="150" /> 
1. On the **Panel settings** page, click threshold <img src={useBaseUrl('/img/monitors/thresholds-icon.png')} alt="thresholds-icon"
width="40" /> icon to view the values that you have defined for the Monitor.
