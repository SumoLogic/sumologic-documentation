...
<img src={useBaseUrl('img/icons/operations/alert-and-notify.png')} alt="Alert and notify" width="40"/>
...
* **F**. Opens the [playbook associated with this monitor](/docs/alerts/monitors/create-monitor/#step-4-playbook-optional).  
   * Playbooks allow admins to codify tribal knowledge for an on-call so they know what exactly to do when they receive an alert:<br/><img src={useBaseUrl('img/alerts/monitors/playbook-example.png')} alt="Playbook example" style={{border: '1px solid gray'}} width="250" />
