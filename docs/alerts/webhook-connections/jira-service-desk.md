...
1. For **Connection Type**, select **Jira** from the dropdown.<br/><img src={useBaseUrl('img/connection-and-integration/jira-cloud-dropdown.png')} alt="Jira Cloud dropdown menu" style={{border: '1px solid gray'}} width="500" />
1. In the **Connection Settings** dialog, enter:
   ...
   * The following input fields are automatically updated in the JSON **Payload** and vice versa. Update them to meet your requirements. At a minimum, you'll need to enter a valid project key.
      ...
      * (optional) **Priority**
      * **Issue Description**
      <img src={useBaseUrl('img/connection-and-integration/create-new-connection-jira-service-desk.png')} alt="Create New Connection Jira Service Desk" style={{border: '1px solid gray'}} width="500" />
