...
To access [ServiceNow connections](/docs/alerts/webhook-connections/servicenow/), go to **Manage Data** > **Monitoring** > **Connections**. From here, you can search, edit, delete, and view of the details of Connections.
