...
1. Create the search that you would like to integrate with ServiceNow. Click **Save As** under the query currently displayed in the search box.<br/><img src={useBaseUrl('img/connection-and-integration/ScheduleSearch.png')} alt="Schedule search" style={{border: '1px solid gray'}} width="500" />
