...
1. For **Connection Type**, select **Azure Functions** from the dropdown.<br/><img src={useBaseUrl('img/connection-and-integration/azure-functions-dropdown.png')} alt="Azure Functions Dropdown" style={{border: '1px solid gray'}} width="500" />
1. In the **Connection Settings** dialog, enter:
    ...
    * (Optional) **Custom Headers**. Enter up to five comma separated key-value pairs.
      <img src={useBaseUrl('img/connection-and-integration/create-new-connection-azure-functions.png')} alt="Create New Connection Azure Functions" style={{border: '1px solid gray'}} width="500" />
