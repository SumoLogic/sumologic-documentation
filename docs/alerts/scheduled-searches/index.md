...
For instructions, see [Script Action] (../../03Send-Data/Sources/01Sources-for-Installed-Collectors/Script-Action.md "Script Action").
...
You can trigger the creation of a CSE Signal with a scheduled search. Signals are otherwise generated when the conditions of a CSE rule are satisfied by a Record. Signals are correlated with other Signals to create a [CSE Insight] (../../Cloud_SIEM_Enterprise/Records,_Signals,_Entities,_and_Insights/00Insight_Generation_Process.md "Insight Generation Process").
 
