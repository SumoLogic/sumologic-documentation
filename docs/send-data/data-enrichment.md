...
* You can use the [lookup operator](../search/search-query-language/search-operators/lookup) to enrich your log data with contextual information from the Lookup Table.
* You can use the [lookupContains](../search/search-query-language/search-operators/lookupContains) operator to see whether a key exists in a Lookup Table.
...
* You can use the can [save operator](../search/search-query-language/search-operators/save) to update the contents of an existing Lookup Table.
