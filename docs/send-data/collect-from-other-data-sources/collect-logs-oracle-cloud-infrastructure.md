...
13. Deploy your function.
    ...
    ```
14. Create the following environment variable configurations in the Oracle console for the function
    * Endpoint
...
<img src={useBaseUrl('img/send-data/OCI_Service_Connector.png')} alt="OCI to Sumo" style={{border: '1px solid gray'}} width="1800" />
