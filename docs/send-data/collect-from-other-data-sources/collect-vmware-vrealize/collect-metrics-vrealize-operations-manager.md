...
1. Follow the instructions to configure a [Streaming Metrics Source](../../Sources/01Sources-for-Installed-Collectors/Streaming-Metrics-Source.md). Make sure that the Content-Type is set to Carbon1.
