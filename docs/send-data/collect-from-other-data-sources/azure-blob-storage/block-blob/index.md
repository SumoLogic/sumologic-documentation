...
Logs and metrics for most Azure services can be exported to Azure Storage Account as block blobs. This page describes a Sumo Logic integration that provides an event-based pipeline for shipping monitoring data from Azure Blob Storage to an HTTP source on Sumo Logic. 
...
<img src={useBaseUrl('/img/send-data/Azure-Sumo-pipeline-Sumologic.png')} alt="Azure-Sumo Logic pipeline" style={{border: '1px solid gray'}} width="800" />
...
* Three Azure functions—TaskProducer, TaskConsumer, and DLQTaskConsumer—that are responsible for sending monitoring data to Sumo Logic.
