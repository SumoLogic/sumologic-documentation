...
## Azure Intetgration FAQs 

For answers to frequently asked questions (FAQs) about integrating Azureinto an enterprise environment using ARM (Azure Resource Manager) architecture, see Azure Integrations using ARM.
