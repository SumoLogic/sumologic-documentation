...
1. In Sumo Logic, create a Hosted Collector, using the instructions in [Set up a Hosted Collector](/docs/send-data/sources/hosted-collectors/configure-hosted-collector). 
