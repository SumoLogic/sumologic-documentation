...
CloudFormation based approach is recommended. If you would rather manually configure a Lambda function see [Collect Amazon CloudWatch Logs with Lambda Function](collect-with-lambda-function.md).
