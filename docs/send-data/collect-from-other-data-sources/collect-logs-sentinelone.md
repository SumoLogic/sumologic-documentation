...
1. Configure a Cloud Syslog [Hosted Collector](../Collector-FAQs/Configure_Limits_for_Collector_Caching.md) and [Cloud Syslog Source](/docs/send-data/sources/sources-hosted-collectors/cloud-syslog-source), and generate a Cloud Syslog source token. 
