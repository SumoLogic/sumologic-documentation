...
These topics have information about using Telegraf, an open source, plugin-based collector, to obtain metrics from an application and to send those metrics to Sumo Logic.  
