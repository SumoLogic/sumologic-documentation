...
1. On the left panel, select **Windows** as the platform.<br/> <img src={useBaseUrl('img/send-data/opentelemetry-collector/otel-Windows.png')} alt="widows-terminal" style={{border: '1px solid gray'}} width="900"/>
