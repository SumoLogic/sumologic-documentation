...
1. (Optional) In the **Collector Settings**, select **Ephemeral** checkbox to auto-delete your collector after 12 hours and select **Locally Manage Collector** checkbox if you want to configure, maintain, and montor collector locally.
