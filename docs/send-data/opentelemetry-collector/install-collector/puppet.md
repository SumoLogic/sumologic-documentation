...
3. On the left panel, select **Puppet**.<br/><img src={useBaseUrl('img/send-data/puppet-new.png')} style={{border: '1px solid gray'}} alt="Puppet" />
...
7. Select the operating system on which you want to install the collector using Puppet:
    - **Linux**
      <img src={useBaseUrl('img/send-data/Puppet-linux.png')} style={{border: '1px solid gray'}} alt="Puppet" />
    - **Windows**
      <img src={useBaseUrl('img/send-data/Puppet-windows.png')} style={{border: '1px solid gray'}} alt="Puppet" />
