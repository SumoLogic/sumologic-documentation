...
- Receiver uses [INFO command](https://redis.io/docs/latest/commands/info/) to get Redis statistics

- Make sure to set the Redis user's password as an environment variable for OpenTelemetry agent. Refer to the [Setting Environment Variables with Secret Values for Source Templates.](../st-with-secrets.md). 
...
- **Username**. Optional. Enter the Redis username, in case you are using specific user for monitoring.
