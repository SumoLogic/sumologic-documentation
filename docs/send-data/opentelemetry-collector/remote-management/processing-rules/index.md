...
* [Mask messages that match](mask-rules.md). Replace an expression with a mask string that you can customize. This is another option to protect your data, such as passwords, that you do not normally track.
