...
* [Linux Proxy](https://help.sumologic.com/docs/send-data/opentelemetry-collector/install-collector-linux/#using-proxy)
* [Windows Proxy](https://help.sumologic.com/docs/send-data/opentelemetry-collector/install-collector-windows/#using-proxy)
* [MacOS Proxy](https://help.sumologic.com/docs/send-data/opentelemetry-collector/install-collector-macos/#using-proxy))
...
Refer to the Uninstall section in the below mentioned docs
