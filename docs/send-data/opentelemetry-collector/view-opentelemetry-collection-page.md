...
1. Click on the desired collector.<br/><img src={useBaseUrl('img/send-data/opentelemetry-collector/otel-collector-details.png')} alt="OpenTelemetry collection details page" style={{border:'1px solid gray'}} width="400"/>
    - **Basic Info**
        ...
        - **Data Ingested**. Displays the histogram showing data ingested (logs and traces) in the last hour. This histogram timeline reflects the data ingestion timestamp as closely as possible, but minor variations may occur.
            :::note
