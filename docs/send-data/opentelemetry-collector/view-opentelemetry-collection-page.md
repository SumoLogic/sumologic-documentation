...
1. On the **OpenTelemetry Collection** page, click the **Click to add a filter** bar and then select **Upgrade Available**.<br/><img src={useBaseUrl('img/send-data/otel-upgrade-available-filter.png')} alt="OpenTelemetry upgrade available filter" style={{border:'1px solid gray'}} width="400" />
