...
* On the [**Collection**](/send-data/collection/) page, click **Add Collector**, click **Installed Collector**, and then click the link for the collector to begin the download.
