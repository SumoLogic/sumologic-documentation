...
From the **Data Collection** page, you can edit characteristics of a Source, including its name, description, Collection time, Source Host, Source Category, Advanced options, and Processing Rules.
...
1. Click **Save** to apply your changes.<br/><img src={useBaseUrl('img/collector/edit-local-file-source.png')} alt="Edit local file source" style={{border: '1px solid gray'}} width="600" />
