...
<div className="box smallbox card">
  ...
  <a href={useBaseUrl('docs/send-data/hosted-collectors/microsoft-source/azure-metrics-source')}><img src={useBaseUrl('img/send-data/ms-azure-metrics.svg')} alt="icon" width="60"/><h4>Azure Metrics Source</h4></a>
