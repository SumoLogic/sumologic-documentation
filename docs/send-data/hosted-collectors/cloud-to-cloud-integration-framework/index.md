    ...
    <div className="container">
      ...
      <div className="box smallbox card">
        ...
        <p>Learn how to collect report logs from Trust Login platform.</p>
            ...
            <div className="box smallbox card">
        <div className="container">
        <a href={useBaseUrl('docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/universal-connector-source')}><img src={useBaseUrl('img/sumo-square.png')} alt="Thumbnail icon" width="50"/><h4>Universal Connector Source</h4></a>
