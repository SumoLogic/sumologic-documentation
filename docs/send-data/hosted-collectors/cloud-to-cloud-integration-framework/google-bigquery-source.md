...
import ExampleJSON from '/img/c2c/google-bigquery/example.json';
import MyComponentSource from '!!raw-loader!/img/c2c/google-bigquery/example.json';
import TerraformExample from '!!raw-loader!/img/c2c/google-bigquery/example.tf';
...
[Download example](/img/c2c/google-bigquery/example.json)

### Terraform example

<CodeBlock language="json">{TerraformExample}</CodeBlock>

[Download example](/img/c2c/google-bigquery/example.tf)
