...
import ExampleJSON from '/img/c2c/zero-networks-segment/example.json';
import MyComponentSource from '!!raw-loader!/img/c2c/zero-networks-segment/example.json';
import TerraformExample from '!!raw-loader!/img/c2c/zero-networks-segment/example.tf';
