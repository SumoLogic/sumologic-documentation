...
1. Search for and select **JFrog Xray** icon.
...
1. In **JFrog Base URL**, enter your Jfrog instance domain. E.g. `https://acme.jfrog.io`
...
1. (Optional) The **Polling Interval** is set for 5 minutes default, you can adjust it based on your needs.
