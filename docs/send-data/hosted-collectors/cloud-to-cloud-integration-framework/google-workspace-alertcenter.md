...
1. JSON for the service account is automatically downloaded. To see what the JSON looks like, and how the JSON fields map to the fields you'll configure. Find the [Service account JSON](#example-of-service-account-json) example below.
