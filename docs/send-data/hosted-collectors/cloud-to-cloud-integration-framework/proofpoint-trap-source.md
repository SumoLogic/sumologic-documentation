...
:::note
The Proofpoint TRAP API documentation is not public and is [accessible only with a Support Community account](https://proofpoint.my.site.com/community/s/article/Threat-Response-TRAP-How-to-Access-Threat-Response-Auto-Pull-TRAP-documentation).
:::
