...
description: This integration collects threat indicators data from the Intel471 API and sends them to Sumo Logic as normalized threat indicators for analysis.
---
...
<img src={useBaseUrl('img/send-data/intel471-threat-intel.png')} alt="sentinelone-icon.png" width="50" />
