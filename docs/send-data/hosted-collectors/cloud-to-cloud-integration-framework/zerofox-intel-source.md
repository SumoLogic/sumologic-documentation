...
- Use the [ZeroFox Automation Service Integration](/docs/platform-services/automation-service/app-central/integrations/zerofox/) to automate response actions directly from Cloud SIEM or Cloud SOAR playbooks.