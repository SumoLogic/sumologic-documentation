...
1. When ![configuring the Azure Event Hubs Source](https://help.sumologic.com/ja/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/azure-event-hubs-source/) in Sumo Logic our input fields would be:
