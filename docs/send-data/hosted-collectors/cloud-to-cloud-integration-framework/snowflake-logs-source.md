...
import MyComponentSource from '!!raw-loader!/files/c2c/snowflake-logs/example.json';
import TerraformExample from '!!raw-loader!/files/c2c/snowflake-logs/example.tf';
...
<a href="/files/c2c/snowflake-logs/example.json" target="_blank">Download example</a>

### Terraform example

<CodeBlock language="json">{TerraformExample}</CodeBlock>

<a href="/files/c2c/snowflake-logs/example.tf" target="_blank">Download example</a>
