...
1. (Optional) **Parser path**. If **Forward to SIEM** option is selected, provide a [parser path](https://github.com/SumoLogic/siem-content-catalog/blob/master/parsers/README.md).
