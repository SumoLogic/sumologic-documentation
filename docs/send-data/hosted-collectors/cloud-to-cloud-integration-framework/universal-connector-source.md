...
| progressWindowSize         | String      | Yes      | `"5m"`            | The size of each polling time window chunk. Accepts duration strings such as `5m`, `1h`. Must be between `1m` and `24h`.                                                                                                                | `"progressWindowSize": "5m"`                                                                                                                                                                                                                              |
| progressWindowInitLookback | String      | Yes      | `"24h"`           | How far back the source should start collecting data when first created. This setting has no effect after the initial creation.                                                                                                          | `"progressWindowInitLookback": "24h"`                                                                                                                                                                                                                     |
