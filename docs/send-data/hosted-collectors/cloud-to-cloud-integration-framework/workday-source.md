...
:::note
The steps below assume that you have already configured in [Step 1 of this page] (docs/integrations/saas-cloud-apps/Workday/Collect_Logs_for_the_Workday_App#step-1-configure-the-workday-portal). You will copy and paste configurations from those steps in this source.
:::
