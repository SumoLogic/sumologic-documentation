...
1. Click **Apply**. The API key is added and a popup window containing the new API key is displayed.
1. Click **Copy** to copy the API Key that is generated by the Cato Management Application and save it to a secure location.
:::note
