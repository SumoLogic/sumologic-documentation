...
1. Select **Use my.idaptive.app domain for token URL** checkbox if you are using use **my.idaptive.app** domain in your cyberark audit credentials. By default, this checkbox will not be selected and it will use **id.cyberark.cloud** domain.
...
| useIdaptiveDomain | Boolean | No | `null` |  Specify if we need to use my.idaptive.app domain. | |
