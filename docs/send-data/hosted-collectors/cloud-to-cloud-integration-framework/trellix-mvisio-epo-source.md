...
1. Go to the **Self service** menu and click [**API Access Management**](https://developer.manage.trellix.com/mvision/selfservice/access_manag) option.<br/><img src={useBaseUrl('img/send-data/self-service.jpg')} alt="self-service.png" style={{border: '1px solid gray'}} width="600" />
