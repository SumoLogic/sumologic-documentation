...
1. Go to **Self service > [API Access Management](https://developer.manage.trellix.com/mvision/selfservice/access_manag)** page.
1. Copy the **API key** from the API Access Management section.
