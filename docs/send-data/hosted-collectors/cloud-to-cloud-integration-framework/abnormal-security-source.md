...
1. In the **IP Safelist** field, enter a specific [IPv4 / IPv6 address](docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/#static-ip-addresses) as per your deployment.<br/><img src={useBaseUrl('img/send-data/integrations.png')} alt="integrations" style={{border: '1px solid black'}} width="800" />
