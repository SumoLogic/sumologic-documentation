...
<a href="/files/c2c/zendesk/example.json" target="_blank">Download example</a>

### Terraform example

<CodeBlock language="json">{TerraformExample}</CodeBlock>

<a href="/files/c2c/zendesk/example.tf" target="_blank">Download example</a>
