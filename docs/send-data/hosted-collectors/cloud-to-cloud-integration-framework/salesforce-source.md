...
1. For authentication, enter the following cURL command in your terminal. Be sure to replace the **Client ID** (Consumer Key of the Connected App) and **Client Secret** (Consumer Secret of the Connected App) with your own.
   ```
   curl --location '<SIGN_IN_URL>/services/oauth2/token'
