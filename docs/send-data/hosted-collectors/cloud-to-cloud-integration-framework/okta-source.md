...
This Source is not available in the [Fed deployment] (/APIs/Troubleshooting-APIs/Deployments-and-Sumo-Logic-Endpoints). Use the [legacy collection method for Okta] (/07Sumo-Logic-Apps/saml/Okta/Collect_logs_for_Okta).
