...
| accountId | String | Yes | `null` | Account ID is a unique identifier for your Enterprise Account. | modifiable |
| personalAccessTokens | String | Yes | `null` | Used to authenticate API requests. | modifiable |
