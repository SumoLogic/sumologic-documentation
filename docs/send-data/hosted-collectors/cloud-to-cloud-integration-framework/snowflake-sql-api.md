...
```json reference
https://github.com/SumoLogic/sumologic-documentation/blob/main/static/files/c2c/snowflake-sql-api/metrics_schema.json
```
...
```json reference
https://github.com/SumoLogic/sumologic-documentation/blob/main/static/files/c2c/snowflake-sql-api/metrics_example.json
```
