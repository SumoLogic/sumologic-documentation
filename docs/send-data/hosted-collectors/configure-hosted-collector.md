...
<div className="box smallbox card">
  <div className="container">
  <img src={useBaseUrl('img/integrations/microsoft-azure/azure.png')} alt="Azure icon" width="50"/>
  ...
  <p>Collect data from Microsoft Office 365 Audit.</p>
    ...
    <div className="box smallbox card">
      <div className="container">
      <img src={useBaseUrl('img/integrations/google/google-logo.png')} alt="Google icon" width="50"/>
    ...
    <div className="box smallbox card">
      <div className="container">
      <img src={useBaseUrl('img/send-data/http-logs-metrics.png')} alt="HTTP Logs Metrics icon" width="50"/>
