...
Refer to [Troubleshooting Common Kubernetes Collection Issues](/docs/send-data/kubernetes/troubleshooting-collection/common-issues.md#opentelemetry-dial-tcp-lookup-collection-sumologic-metadata-logssumologicsvcclusterlocal-device-or-resource-busy).
