...
This has already been called out in the v4 upgrade guide. This is only applicable now for those who were still using the Prometheus operator in v4 and just migrating to the OpenTelemetry operator in v5.
