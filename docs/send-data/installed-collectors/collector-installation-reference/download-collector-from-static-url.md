...
:::note
This document provides static URLs to download our [Installed Collector](/docs/send-data/installed-collectors) agent. If you need our **Distribution of OpenTelemetry**, go to our [OpenTelemetry Collector](/docs/send-data/opentelemetry-collector/) for more details.
:::
