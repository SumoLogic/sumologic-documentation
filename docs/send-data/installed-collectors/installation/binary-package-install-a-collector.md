...
sidebar_label: Install Collector Using Binary Package
...
To verify that the Collector is installed, go to **Manage > Collection** and verify that you can see the Collector.
