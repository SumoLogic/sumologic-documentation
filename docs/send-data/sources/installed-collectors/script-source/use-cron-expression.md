...
:::note
For examples, see [CRON Examples and Reference](Cron-Examples-and-Reference.md "Cron Examples and Reference"). 
:::
...
1. If you'd like to filter data being collected, set **Filter** options. See [Create a Processing Rule](/Manage/Collection/Processing-Rules/Create-a-Processing-Rule) for more information.
