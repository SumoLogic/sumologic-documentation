...
1. If you'd like to filter data being collected, set **Processing Rule** options. [Hash and Mask filters](../../../../manage/collection/processing-rules/create-processing-rule.md) can be used to obfuscate proprietary information included in data collected from a script source.
