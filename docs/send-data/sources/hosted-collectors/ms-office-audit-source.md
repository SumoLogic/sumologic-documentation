...
1. Click **Add Source** next to a Hosted Collector. See [Set Up a Hosted Collector](/docs/send-data/sources/hosted-collectors/configure-hosted-collector) for instructions on setting up a new Hosted Collector.
