...
Sources can be configured using UTF-8 encoded JSON files with the [Collector Management API](https://help.sumologic.com/APIs/Collector-Management-API). See [how to use JSON to configure Sources](/docs/send-data/sources/use-json-configure-sources/index.md) for details.
