...
See [Use JSON to Configure Sources](/docs/send-data/sources/use-json-configure-sources) for a list of common parameters.
...
In addition to the [common parameters](/docs/send-data/sources/use-json-configure-sources), the following parameters are for a Cloud Syslog Source.
...
In addition to the [common parameters](/docs/send-data/sources/use-json-configure-sources), the following parameters are for all AWS log Sources except Kinesis.
