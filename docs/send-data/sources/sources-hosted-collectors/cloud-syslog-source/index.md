---
slug: /send-data/sources/sources-hosted-collectors/cloud-syslog-source
---
...
1. On the **Collection** page, click **Add Source** next to a Hosted Collector.  See [Set up a Hosted Collector](../../../configure-hosted-collector.md) for information on adding Hosted Collectors.
