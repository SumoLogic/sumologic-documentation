...
1. (Optional) For **Source Host** and **Source Category**, enter any string to tag the output collected from the source. These are [built-in metadata](/05Search/Get-Started-with-Search/Search-Basics/Built-in-Metadata) fields that allow you to organize your data.
