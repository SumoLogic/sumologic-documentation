...
:::tip
EC2 metrics have high latency and can increase the costs of your AWS account. For EC2 metrics, consider [Installing a Collector with a Host Metrics Source](../../sources-installed-collectors/host-metrics-source.md). The advantage is near zero latency and more information at a lower overall cost.
:::
