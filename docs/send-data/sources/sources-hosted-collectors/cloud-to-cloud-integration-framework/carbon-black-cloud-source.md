...
|--|--|--|--|--|
| config | JSON Object  | Yes | Contains the [configuration parameters](./Carbon_Black_Cloud_Source.md "Carbon Black Defense Source") for the Source. |   |
