...
1. Select **Dropbox**.
    ...
    ![dropbox-icon.png](/img/send-data/dropbox-icon.png)

1. Enter a **Name** for the Source. The **description** is optional.

    ![dropbox-input.png](/img/send-data/dropbox-input.png)
...
1. **App Key**, **App Secret**, and **Access Code**. Provide your Dropbox [authentication](./Dropbox_Source.md "Dropbox Source") credentials.

1. **Processing Rules**. Configure any desired filters, such as allowlist, denylist, hash, or mask, as described in [Create a Processing Rule](/Manage/Collection/Processing-Rules/Create-a-Processing-Rule).
