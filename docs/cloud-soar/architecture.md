...
Cloud Soar provides static egress for Cloud executions. IP addresses can be entered into the allowlist. For a list of Cloud Soar addresses by region, contact [support](https://support.sumologic.com/hc/en-us).
