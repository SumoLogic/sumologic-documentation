  ...
  senddata: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'send-data/opentelemetry-collector/comparison',
            'send-data/opentelemetry-collector/installation',
            'send-data/opentelemetry-collector/configuration-sources',
            'send-data/opentelemetry-collector/performance',
            'send-data/opentelemetry-collector/best-practices',
            'send-data/opentelemetry-collector/opentelemetry-concepts',
            'send-data/opentelemetry-collector/fips',
            'send-data/opentelemetry-collector/known-issues',
            'send-data/opentelemetry-collector/troubleshooting',
            'send-data/opentelemetry-collector/upstream-relation',
          ],
        },
        {
          type: 'category',
