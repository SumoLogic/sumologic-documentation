      ...
      'manage/health-events',
    {
      ...
      items: [
        ...
        'manage/field-extractions/edit-field-extraction-rules',
        {
          ...
          collapsible: true,
          collapsed: true,
          link: {type: 'doc', id: 'manage/field-extractions/field-extraction-rule-templates/index'},
          items: [
            'manage/field-extractions/field-extraction-rule-templates/akamai-cloud-monitor',
            'manage/field-extractions/field-extraction-rule-templates/apache-access-logs',
            'manage/field-extractions/field-extraction-rule-templates/apache-tomcat-access-logs',
            'manage/field-extractions/field-extraction-rule-templates/apache-tomcat-access-log-fer',
            'manage/field-extractions/field-extraction-rule-templates/aws-cloudtrail-logs',
            'manage/field-extractions/field-extraction-rule-templates/aws-elastic-load-balancing-logs',
            'manage/field-extractions/field-extraction-rule-templates/aws-s3-usage-logs',
            'manage/field-extractions/field-extraction-rule-templates/cisco-app',
            'manage/field-extractions/field-extraction-rule-templates/cisco-fwsm-fer',
            'manage/field-extractions/field-extraction-rule-templates/microsoft-iis-logs',
            'manage/field-extractions/field-extraction-rule-templates/nginx-logs',
            'manage/field-extractions/field-extraction-rule-templates/palo-alto-networks',
            'manage/field-extractions/field-extraction-rule-templates/varnish-logs',
          ]
        },
