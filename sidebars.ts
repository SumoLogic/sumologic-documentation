  ...
  senddata: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'send-data/installed-collectors/overview',
            'send-data/installed-collectors/download-collector-from-static-url',
            'send-data/installed-collectors/binary-package-install-a-collector',
            'send-data/installed-collectors/add-collector-linux-machine-image',
            'send-data/installed-collectors/add-collector-windows-machine-image',
            'send-data/installed-collectors/macos',
            'send-data/installed-collectors/linux',
            'send-data/installed-collectors/windows',
            'send-data/installed-collectors/parameters-command-line-installer',
            'send-data/installed-collectors/user-properties',
            'send-data/installed-collectors/collector-properties',
            'send-data/installed-collectors/set-run-as-user-for-collector',
            'send-data/installed-collectors/enable-sni-collector-transparent-proxy',
            'send-data/installed-collectors/force-collectors-name-clobber',
            'send-data/installed-collectors/set-collector-as-ephemeral',
            'send-data/installed-collectors/enhanced-file-system-security-installed-collectors',
            'send-data/installed-collectors/sumoconf-for-legacy-collectors',
            'send-data/installed-collectors/advanced-ui-installer-settings',
            {
              type: 'category',
              label: 'Sources',
              collapsible: true,
