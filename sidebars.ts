      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              type: 'category',
              label: 'Cloud-to-Cloud (C2C) Integration Framework Sources',
              collapsible: true,
              collapsed: true,
              ...
              items: [
                {
                  type: 'autogenerated',
                  dirName: 'send-data/hosted-collectors/cloud-to-cloud-integration-framework' // Generate sidebar slice with the elements from this directory
                }
              ],
            },
            {
