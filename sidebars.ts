...
// *** SEND DATA
      ...
      items: [
        ...
        },
        {
          ...
          collapsible: true,
          collapsed: true,
          link: {type: 'doc', id: 'send-data/opentelemetry/index'},
          items: [
            'send-data/opentelemetry/sumo-distribution-opentelemetry',
            'send-data/opentelemetry/installation',
            'send-data/opentelemetry/configuration',
            'send-data/opentelemetry/migration',
            'send-data/opentelemetry/comparison',
            'send-data/opentelemetry/performance',
            'send-data/opentelemetry/best-practices',
            'send-data/opentelemetry/opentelemetry-concepts',
            'send-data/opentelemetry/fips',
            'send-data/opentelemetry/known-issues',
            'send-data/opentelemetry/troubleshooting',
            'send-data/opentelemetry/upstream-relation',
          ],
        },
        {
          type: 'category',
