  ...
  senddata: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Sumo Logic Distribution for OpenTelemetry Collector',
          collapsible: true,
          collapsed: true,
          link: {type: 'doc', id: 'send-data/sumo-distribution-opentelemetry/index'},
          items: [
            'send-data/sumo-distribution-opentelemetry/comparison',
            'send-data/sumo-distribution-opentelemetry/installation',
            'send-data/sumo-distribution-opentelemetry/configuration-sources',
            'send-data/sumo-distribution-opentelemetry/performance',
            'send-data/sumo-distribution-opentelemetry/best-practices',
            'send-data/sumo-distribution-opentelemetry/opentelemetry-concepts',
            'send-data/sumo-distribution-opentelemetry/fips',
            'send-data/sumo-distribution-opentelemetry/known-issues',
            'send-data/sumo-distribution-opentelemetry/troubleshooting',
            'send-data/sumo-distribution-opentelemetry/upstream-relation',
          ],
        },
        {
          type: 'category',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'cse/ingestion/aws-guardduty',
            'cse/ingestion/aws-network-firewall',
            'cse/ingestion/aws-vpc-flow',
            'cse/ingestion/carbon-black',
            'cse/ingestion/check-point-firewall',
            'cse/ingestion/cisco-asa',
            ...
            'cse/ingestion/microsoft-audit-office',
            'cse/ingestion/microsoft-azure-activity-log',
            'cse/ingestion/microsoft-windows',
            'cse/ingestion/nginx-access-logs',
            'cse/ingestion/okta',
            'cse/ingestion/onelogin',
            'cse/ingestion/osquery',
            'cse/ingestion/palo-alto-firewall',
            'cse/ingestion/sentinelone',
            'cse/ingestion/signal-sciences-waf',
            'cse/ingestion/symantec-proxy-secure-gateway',
