...
// *** SEND DATA
      ...
      items: [
        ...
        },
        {
          ...
          collapsible: true,
          collapsed: true,
          link: {type: 'doc', id: 'send-data/sumo-logic-opentelemetry/index'},
          items: [
            'send-data/sumo-logic-opentelemetry/download-collector',
            'send-data/sumo-logic-opentelemetry/installation',
            'send-data/sumo-logic-opentelemetry/configuration',
            'send-data/sumo-logic-opentelemetry/migration',
            'send-data/sumo-logic-opentelemetry/comparison',
            'send-data/sumo-logic-opentelemetry/performance',
            'send-data/sumo-logic-opentelemetry/best-practices',
            'send-data/sumo-logic-opentelemetry/opentelemetry-concepts',
            'send-data/sumo-logic-opentelemetry/fips',
            'send-data/sumo-logic-opentelemetry/known-issues',
            'send-data/sumo-logic-opentelemetry/troubleshooting',
            'send-data/sumo-logic-opentelemetry/upstream-relation',
          ],
        },
        {
          type: 'category',
