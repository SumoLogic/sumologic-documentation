...
// *** METRICS & LOGS: all metrics content
  ...
  data: [
    ...
    },
    {
      ...
      items: [
        ...
        'send-data/installed-collectors/install-collector-linux',
        {
          ...
          collapsible: true,
          collapsed: false,
          link: {type: 'doc', id: 'send-data/sources/installed-collectors/collector-installation-reference/index'},
          items: [
    ...
    },
    {
      ...
      items: [
        'send-data/sources/collector-faqs/collector-fails-sumo-connection',
        'send-data/sources/collector-faqs/collector-locks-log-files-windows',
        'send-data/sources/collector-faqs/collector-tanuki-wrapper-integration',
        'send-data/sources/collector-faqs/configure-limits-collector-caching',
        'send-data/sources/collector-faqs/delete-data-already-collected',
        'send-data/sources/collector-faqs/enabling-updated-remote-windows-event-collection',
        'send-data/sources/collector-faqs/file-locking-problems',
        'send-data/sources/collector-faqs/increase-collector-memory',
        'send-data/sources/collector-faqs/increase-max-threads-collector',
        'send-data/sources/collector-faqs/increase-windows-event-messages-retrieval',
        'send-data/sources/collector-faqs/ingest-old-historical-data',
        'send-data/sources/collector-faqs/troubleshooting-time-discrepancies',
        'send-data/sources/collector-faqs/verify-collecting-data',
      ],
    },
  ],
