  ...
  data: [
    ...
    },
    {
      ...
      items: [
        ...
        'send-data/hosted-collectors/g-suite-apps-audit-source',
        'send-data/hosted-collectors/google-cloud-platform-source',
        'send-data/hosted-collectors/gcp-metrics-source',
        'send-data/hosted-collectors/http-traces-source',
        'send-data/hosted-collectors/ms-office-audit-source',
        'send-data/hosted-collectors/otlp-http-source',
        {
          type: 'category',
          ...
          items: [
            ...
            'send-data/hosted-collectors/amazon-aws/configure-our-aws-source-cloudformation',
        ...
        },
        {
          ...
          collapsible: true,
          collapsed: true,
          link: {type: 'doc', id: 'send-data/hosted-collectors/http-logs-metrics-source/index'},
          items: [
            'send-data/hosted-collectors/http-logs-metrics-source/upload-logs-http-source',
            'send-data/hosted-collectors/http-logs-metrics-source/upload-metrics-to-http-source',
            'send-data/hosted-collectors/http-logs-metrics-source/prometheus-metrics-not-accepted-by-sumo',
            'send-data/hosted-collectors/http-logs-metrics-source/generate-new-url-http-source',
            'send-data/hosted-collectors/http-logs-metrics-source/troubleshooting-http-sources',
          ],
        },
      ],
    },
