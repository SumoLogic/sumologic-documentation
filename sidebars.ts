...
module.exports = {
  ...
  metricslogs: [
    ...
    },
    {
      ...
      collapsible: true,
      collapsed: false,
      link: {type: 'doc', id: 'metrics/metrics-queries-alerts/index'},
      items: [
        'metrics/metrics-queries-alerts/metrics-explorer',
        'metrics/metrics-queries-alerts/metric-query-autocomplete',
        'metrics/metrics-queries-alerts/metrics-explorer-faqs',
        {
          type: 'category',
          label: 'Metrics Operators',
          collapsible: true,
          collapsed: false,
          link: {type: 'doc', id: 'metrics/metrics-queries-alerts/metrics-operators/index'},
          items: [
            'metrics/metrics-queries-alerts/metrics-operators/accum',
            'metrics/metrics-queries-alerts/metrics-operators/along',
            'metrics/metrics-queries-alerts/metrics-operators/avg',
            'metrics/metrics-queries-alerts/metrics-operators/bottomk',
            'metrics/metrics-queries-alerts/metrics-operators/count',
            'metrics/metrics-queries-alerts/metrics-operators/delta',
            'metrics/metrics-queries-alerts/metrics-operators/eval',
            'metrics/metrics-queries-alerts/metrics-operators/fillmissing',
            'metrics/metrics-queries-alerts/metrics-operators/filter',
            'metrics/metrics-queries-alerts/metrics-operators/histogram-quantile',
            'metrics/metrics-queries-alerts/metrics-operators/max',
            'metrics/metrics-queries-alerts/metrics-operators/min',
            'metrics/metrics-queries-alerts/metrics-operators/outlier',
            'metrics/metrics-queries-alerts/metrics-operators/parse',
            'metrics/metrics-queries-alerts/metrics-operators/pct',
            'metrics/metrics-queries-alerts/metrics-operators/quantize',
            'metrics/metrics-queries-alerts/metrics-operators/rate',
            'metrics/metrics-queries-alerts/metrics-operators/sum',
            'metrics/metrics-queries-alerts/metrics-operators/topk',
          ],
        },
        'metrics/metrics-queries-alerts/metric-query-error-messages',
        'metrics/metrics-queries-alerts/share-metric-query',
        'metrics/metrics-queries-alerts/metrics-queries-classic',
      ],
    },
    {
      type: 'category',
