...
This is an archive of the 2023 Sumo Logic Service Release Notes. To view the full Service Release Notes archive, [click here](/release-notes-service/archive).
...
We’re excited to introduce scheduled view ID on scheduled view details pane, which enables faster debugging and improved internal operation efficiency. [Learn more](/docs/manage/views/view-list-scheduled-views).
