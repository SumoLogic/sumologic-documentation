...
We’re excited to introduce scheduled view ID on scheduled view details pane, which enables faster debugging and improved internal operation efficiency. [Learn more](/docs/manage/views/view-list).
