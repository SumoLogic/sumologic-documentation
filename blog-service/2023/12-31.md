...
- [Azure Blob Storage](/docs/send-data/collect-from-other-data-sources/azure-storage/azure-blob-storage/collect-logs-azure-blob-storage)
...
Check out our technical documentation [here](/docs/send-data/collect-from-other-data-sources/azure-storage/azure-blob-storage) to learn more about the updates in Azure Blob Storage Collector.
