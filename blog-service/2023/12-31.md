...
- [Azure Blob Storage](/docs/send-data/collect-from-other-data-sources/azure-storage/azure-blob-storage/block-blob/collect-logs)
...
Check out our technical documentation [here](/docs/send-data/collect-from-other-data-sources/azure-storage/azure-blob-storage/block-blob/collect-logs) to learn more about the updates in Azure Blob Storage Collector.
