---
title: 2023 Release Notes Archive - Service
image: https://assets-www.sumologic.com/company-logos/_800x418_crop_center-center_82_none/SumoLogic_Preview_600x600.jpg?mtime=1617040082
---

import useBaseUrl from '@docusaurus/useBaseUrl';

This is an archive of the 2023 Sumo Logic Service Release Notes. To view the full archive, [click here](/release-notes-service/archive). Release notes are available on our website for a rolling multi-year period. For information about older releases, contact [Support](https://support.sumologic.com/support/s).
...
To learn more, see [Updating Your AWS Observability Stack](/docs/observability/aws/deploy-use-aws-observability/v2.15.0/update-aws-observability-stack).
...
* [KnowBe4 KMSAT](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/knowbe4-kmsat-source/)
...
We're excited to announce the release of our new cloud-to-cloud source for Trellix. This source collects event logs using the Trellix mVision ePO API. [Learn more](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/trellix-source).
...
For more information on updating the AWS Observability to the latest version, see [Update AWS Observability Stack](/docs/observability/aws/deploy-use-aws-observability/v2.15.0/update-aws-observability-stack/).
