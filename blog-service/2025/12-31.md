...
This is an archive of the 2025 Sumo Logic Service Release Notes. To view the full archive, [click here](/release-notes-service/archive). Release notes are available on our website for a rolling multi-year period. For information about older releases, contact [Support](https://support.sumologic.com/support/s).

<!--truncate-->

---

### December 31, 2025 (Apps)

#### Apps, Solutions, and Collection Integrations - December Release 

##### New release - LiteLLM

We are excited to announce the addition of a native Sumo Logic HTTP Source webhook integration for collecting LiteLLM usage and proxy log data in Sumo Logic. [Learn more](https://docs.litellm.ai/docs/observability/sumologic_integration).
...
As part of ongoing evaluation, Sumo Logic will deprecate the [Global Intelligence for Apache](/docs/integrations/global-intelligence/), [Global Intelligence for Apache Tomcat](/docs/integrations/global-intelligence/), and [Global Intelligence for NGINX](/docs/integrations/global-intelligence/) apps, with end of life effective **19 January 2026**. After this date, these apps will no longer be available as standalone experiences or listed in the App Catalog. No customer action is required, and this change will not impact any other Sumo Logic features or functionality. This deprecation allows us to focus on delivering higher-value capabilities, including advancements in Agentic AI.
...
- **Azure OpenAI**. The Azure OpenAI app enables you to track the request volume, token usage, response latency, and error rates, to ensure efficient model utilization and reliable AI-driven application performance. [Learn more](/docs/integrations/microsoft-azure/microsoft-foundry/).
...
- To support this AWS update, Sumo Logic has revised several AWS apps and SIEM parsers. You are requested to reinstall the affected apps.
...
- SIEM parsers have auto-updated and require no customer intervention.
...
#### Confluent Metrics Source

We're excited to announce the release of our new cloud-to-cloud source for Confluent Metrics. This source aims to collect metric data from the Confluent Metrics platform and send them to Sumo Logic for streamlined analysis. [Learn more](/docs/send-data/hosted-collectors/cloud-to-cloud-integration-framework/confluent-metrics-source).
...
Once indicators are ingested and appear on the **Threat Intelligence** tab, SIEM analysts can use the `hasThreatMatch` function in SIEM rules to analyze incoming records for matches to the threat intelligence indicators.

Sumo Logic Threat Intelligence will help you stay ahead of emerging threats and enhance your security posture.

:::note
Only SIEM administrators can add threat intelligence indicators to the datastore.
:::
