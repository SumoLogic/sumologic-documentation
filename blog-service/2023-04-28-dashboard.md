...
- **Sankey Chart**. Our new **Sankey diagram** feature, which can you find under the **Categorical** panel type, is built using two fields in your query, such as `fromstate` and `tostate`. The Sankey diagram helps you understand the flow of the log events within a distributed system. The width of an arrow or stripe in the Sankey diagram shows the proportion of a quantity.
