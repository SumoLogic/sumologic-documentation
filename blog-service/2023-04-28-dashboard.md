...
- **Box Plot Charts**. Our new **Box Plot Charts** feature, which you can find under the **Time Series** and **Categorical** panel type graphically depicts groups of data using quartiles, this is built by including `_min`, `_pct_25`, `_pct_50`, `_pct_75`, and `_max` in your query. 