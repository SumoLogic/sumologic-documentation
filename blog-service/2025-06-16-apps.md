...
- To support this update, Sumo Logic has revised several AWS apps and Cloud SIEM parsers. You must reinstall the affected apps.
- If you use CloudTrail data in saved searches, dashboards, or detection rules, you must update your custom content before AWS enforces the changes on July 14, 2025.
