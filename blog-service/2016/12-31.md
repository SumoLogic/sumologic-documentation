...
**Sumo Logic Service Status Indicator.** If there has been an outage on your [deployment](/docs/APIs/General-API-Information/Sumo-Logic-Endpoints-by-Deployment-and-Firewall-Security) (or pod), the Service Status Indicator displays: at the top of the **Help** menu, next to **Help > Service Status**, and next to the title of a Dashboard. For more information, go to **Help > Service Status**. This will take you to a web page for your pod with details on any outages, incidents, or planned maintenance. For complete details, see [Help Menu](/docs/get-started/help).
