...
Update - [View](/docs/manage/views "Views") queries now provide syntax highlighting and support multiple lines and [comments](/docs/search/get-started-with-search/search-basics/comments-search-queries "Comments in Search Queries").
