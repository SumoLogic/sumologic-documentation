...
We’ve made multiple updates to the [Search Results Table](/docs/search/get-started-with-search/search-page/navigate-messages-in-search-results) to improve the user experience for viewing search results. The enhancements include:
