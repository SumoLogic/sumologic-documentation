...
Update - We’ve released an improvement that eases the processes of administering and monitoring [Sumo Logic Orgs](/docs/manage/manage-subscription/create-and-manage-orgs/create-manage-orgs). To streamline the child org provisioning process, we added support for auto-provisioning SIEM instances for both enterprise and MSSP customers.
