...
For details on upgrade instructions, refer to the [changelog](https://github.com/SumoLogic/sumologic-azure-function/releases/tag/v4.0.0). For more information on logs collection from Azure Blob Storage, see our [documentation](/docs/send-data/collect-from-other-data-sources/azure-blob-storage/collect-logs-azure-blob-storage).