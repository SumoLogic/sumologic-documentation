...
- You can now [Change the Line Properties of a Chart](/docs/dashboards-classic/edit-dashboards), using smooth curved lines (splines), adding markers, and choosing the style of marker for your chart.
- You can now [Change the Label Size](/docs/dashboards-classic/edit-dashboards) for any chart with an X axis.
