...
We are excited to announce our Sumo Logic's Organizations ("Sumo Orgs") feature for Sumo Logic Flex customers. With this release, Flex users can effectively group, provision, manage, and monitor credit usage across multiple organizations, providing greater visibility and control over account structures. [Learn more](/docs/manage/manage-subscription/create-manage-orgs-flex).