...
Check out our technical documentation [here](/docs/integrations/saas-cloud/proofpoint-on-demand) to learn how you can set up and use the proofpoint-on-demand app for Sumo Logic.
