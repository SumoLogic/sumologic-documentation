...
We're excited to introduce the ability to reference any Sumo Logic index with an alias. With this update, you can now use an alias to point to one or more system indexes in the source expression of your search queries.
