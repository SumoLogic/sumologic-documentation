...
- **Remembered Menu State**. The expand/collapse state of the navigation menu is now preserved when opening new tabs, giving you a consistent experience across multiple browser tabs.
...
You can try the new UI by selecting the "Switch to New UI" link within the Classic UI menu. 
