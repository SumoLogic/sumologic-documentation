...
With this update, you can visualize and filter log-level distribution in the Histogram results and Messages table messages of specific log level(s) in the same view. [Learn more](/docs/search/get-started-with-search/search-page/log-level).
