...
<img src={useBaseUrl('img/manage/subscriptions/mssp-orgs-sync-selected-items-no-annotation.png')} alt="Update Selected Items button" style={{border: '1px solid gray'}} width="800"/>
