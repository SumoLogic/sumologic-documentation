...
* Terraform [sumologic_http_source](https://registry.terraform.io/providers/SumoLogic/sumologic/latest/docs/resources/http_source). This resource adds the `token` and `base_url` attributes.
