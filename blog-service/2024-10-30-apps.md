...
- **MongoDB Atlas app updated to v.1.0.11**. New version of MongoDB Atlas collection was released with the below listed changes.
    - Updating MongoDB SAM app to `python3.12`.
    - Memory optimization changes and cluster level filtering added. 
