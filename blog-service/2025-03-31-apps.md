...
- **Added metrics collection capability for OpenTelemetry collectors**. [RabbitMQ](/docs/send-data/opentelemetry-collector/remote-management/source-templates/rabbitmq/#for-metrics-collection), [Redis](/docs/send-data/opentelemetry-collector/remote-management/source-templates/redis/#for-metrics-collection).
...
- **Updated the metric collection and dashboard for Google apps**. [Google BigQuery](/docs/integrations/google/bigquery/), [Google Cloud Load Balancing](/docs/integrations/google/cloud-load-balancing/).
- **Added new dashboards to the Sumo Logic Kickstart Data app (Beta)**. [Sumo Logic Kickstart Data](/docs/integrations/sumo-apps/kickstart-data/).
...
- **Updated the queries for the following apps to accommodate the new threat intel feed**:
**Apps**:
[Acquia](/docs/integrations/saas-cloud/acquia/), [Azure Web Apps](/docs/integrations/microsoft-azure/web-apps/), [JFrog Xray](/docs/integrations/app-development/jfrog-xray/), and [MongoDB Atlas 6](/docs/integrations/databases/mongodb-atlas/).
**OpenTelemetry apps**:
...
Bugs for the following apps were fixed:
