...
- Only use this if the redirect isn't sufficient
...
- [ ] Build test passes (optional: `npx docusaurus build`)
...
**If internal links can't be found**:
...
Next steps:
1. Test locally: npx docusaurus start
