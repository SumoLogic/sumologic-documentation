---
title: 2024 Release Notes Archive - Cloud SOAR
keywords:
  - sumo logic
  - cloud soar
  - automation service
...
This is an archive of 2024 Cloud SOAR release notes. To view the full archive, [click here](/release-notes-csoar/archive). Release notes are available on our website for a rolling multi-year period. For information about older releases, contact [Support](https://support.sumologic.com/support/s).
...
* [Updated] [Slack](/docs/platform-services/automation-service/app-central/integrations/slack/)
* [Updated] [Sumo Logic SIEM](/docs/platform-services/automation-service/app-central/integrations/sumo-logic-siem/)
* [Updated] [Sumo Logic SIEM Internal](/docs/platform-services/automation-service/app-central/integrations/sumo-logic-siem-internal/)
