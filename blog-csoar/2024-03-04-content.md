---
title: March 4, 2024 - Content Release
...
This Cloud SOAR [release](/release-notes-csoar/2024/03/12/application-update/) will feature an important upgrade to Python 3.12 for our Lambda functions. This enhancement is part of our ongoing commitment to security, performance, and the latest technological standards.

The Python upgrade will impact a total of 38 integrations. These integrations will require updates to ensure compatibility with the new Python version.
...
To facilitate a smooth transition, we have prepared a straightforward guide to assist you in updating your integrations. This guide outlines the steps you need to take to ensure your integrations work seamlessly with Python 3.12.

[Click here for the Integration Update Guide](/files/updating-app-central-integrations.pdf)
