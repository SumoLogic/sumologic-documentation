---
title: October 10, 2024 - Content Release
...
* Further mapping updates to better employ [Normalized Classification](https://help.sumologic.com/docs/cse/schema/cse-normalized-classification/) fields across data sources
