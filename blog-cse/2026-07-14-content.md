...
- Updated Office 365 parsing to better extract nested fields and combined separated key value pairs which represent single pairs.
- Updated Microsoft Teams external and guest access detection rules to reflect updated Office 365 parsing
- Updates Okta MFA mapping to remove incorrect classification of logon for events only representing a portion of the logon process.
