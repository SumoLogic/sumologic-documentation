...
This content release includes templates for creating Cloud SIEM parsers. There are two versions of each, one with comments that explain the purpose of each parser component, and “clean” versions that you can use to start 
 quickly creating custom parsers. Further documentation on using these parsers will be available on [Sumo Docs](https://help.sumologic.com) in the coming weeks. Other changes in this release are enumerated below.
