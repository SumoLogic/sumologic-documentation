---
title: 2025 Release Notes Archive - SIEM
keywords:
  - rules
  - signals
  - schema
...
This is an archive of 2025 SIEM release notes. To view the full archive, [click here](/release-notes-cse/archive). Release notes are available on our website for a rolling multi-year period. For information about older releases, contact [Support](https://support.sumologic.com/support/s).
...
[Learn more](/docs/cse/get-started-with-siem/insight-summary/).
...
We’re excited to introduce Sumo Logic Threat Intelligence, a powerful feature set that enables SIEM administrators to seamlessly import indicators of Compromise (IoC) files and feeds directly into Sumo Logic to aid in security analysis.
...
This content release includes:
- Removal and updates to SIEM rules.
...
:::note
In two weeks, MATCH-S00604 "OneLogin - API Credentials - Key Used from Untrusted Location" will be deleted from the out-of-the-box SIEM rules due to unmanageable deny list logic and low adoption. To retain this rule, a duplicate must be made prior to the deletion.
:::
