...
- Fixes for Threat Intelligence rules to correct match expression syntax for hash and HTTP referer
- Parsing and mapping updates for Microsoft Office 365 to improve target user visiblity
