...
#### Summary
Within our latest content release we are introducing a new set of rules related our 5th Threat Research Campaign structured around Docker, Azure and Linux. We are also made Mapper additions to support Cisco Meraki events ingested via C2C, Cyber Ark Mapper improvements, and new Jamf Audit User Event and Jamf Protect Mappers.
