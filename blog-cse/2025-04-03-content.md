...
- New and updated log mappers and parsers for Bitwarden, CommScope, Mimecast, and Sysdig Secure.
    - Updates to Mimecast mappers are to support additional fields and events with new log parser.  
