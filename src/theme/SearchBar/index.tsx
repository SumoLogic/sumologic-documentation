...
type AskAiSidepanelRouteDetail = {
  query: string;
...
function DocSearch({externalUrlRegex, ...props}: DocSearchV4Props) {
  ...
  const routeAskAiToSidepanel = useCallback(
    (detail?: AskAiSidepanelRouteDetail) => {
      ...
      document.dispatchEvent(
        new CustomEvent<AskAiSidepanelRouteDetail>('ask-ai-sidepanel-route', {
          detail: {
            query: trimmedQuery,
      ...
      {isOpen &&
        ...
        createPortal(
          <DocSearchModal
            ...
            {...extraAskAiProps}
            interceptAskAiEvent={routeAskAiToSidepanel}
          />,
          searchContainer.current,
        )}
    </>
